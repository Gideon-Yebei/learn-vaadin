(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const s of n.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function o(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function i(r){if(r.ep)return;r.ep=!0;const n=o(r);fetch(r.href,n)}})();window.Vaadin=window.Vaadin||{};window.Vaadin.featureFlags=window.Vaadin.featureFlags||{};window.Vaadin.featureFlags.exampleFeatureFlag=!1;window.Vaadin.featureFlags.collaborationEngineBackend=!1;window.Vaadin.featureFlags.webPush=!1;window.Vaadin.featureFlags.formFillerAddon=!1;window.Vaadin.featureFlags.reactRouter=!1;const Mr="modulepreload",Vr=function(t,e){return new URL(t,e).href},Go={},f=function(e,o,i){let r=Promise.resolve();if(o&&o.length>0){const n=document.getElementsByTagName("link");r=Promise.all(o.map(s=>{if(s=Vr(s,i),s in Go)return;Go[s]=!0;const l=s.endsWith(".css"),a=l?'[rel="stylesheet"]':"";if(!!i)for(let h=n.length-1;h>=0;h--){const u=n[h];if(u.href===s&&(!l||u.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${s}"]${a}`))return;const d=document.createElement("link");if(d.rel=l?"stylesheet":Mr,l||(d.as="script",d.crossOrigin=""),d.href=s,document.head.appendChild(d),l)return new Promise((h,u)=>{d.addEventListener("load",h),d.addEventListener("error",()=>u(new Error(`Unable to preload CSS for ${s}`)))})}))}return r.then(()=>e()).catch(n=>{const s=new Event("vite:preloadError",{cancelable:!0});if(s.payload=n,window.dispatchEvent(s),!s.defaultPrevented)throw n})};function _t(t){return t=t||[],Array.isArray(t)?t:[t]}function te(t){return`[Vaadin.Router] ${t}`}function Dr(t){if(typeof t!="object")return String(t);const e=Object.prototype.toString.call(t).match(/ (.*)\]$/)[1];return e==="Object"||e==="Array"?`${e} ${JSON.stringify(t)}`:e}const Et="module",St="nomodule",uo=[Et,St];function Ko(t){if(!t.match(/.+\.[m]?js$/))throw new Error(te(`Unsupported type for bundle "${t}": .js or .mjs expected.`))}function er(t){if(!t||!Z(t.path))throw new Error(te('Expected route config to be an object with a "path" string property, or an array of such objects'));const e=t.bundle,o=["component","redirect","bundle"];if(!_e(t.action)&&!Array.isArray(t.children)&&!_e(t.children)&&!kt(e)&&!o.some(i=>Z(t[i])))throw new Error(te(`Expected route config "${t.path}" to include either "${o.join('", "')}" or "action" function but none found.`));if(e)if(Z(e))Ko(e);else if(uo.some(i=>i in e))uo.forEach(i=>i in e&&Ko(e[i]));else throw new Error(te('Expected route bundle to include either "'+St+'" or "'+Et+'" keys, or both'));t.redirect&&["bundle","component"].forEach(i=>{i in t&&console.warn(te(`Route config "${t.path}" has both "redirect" and "${i}" properties, and "redirect" will always override the latter. Did you mean to only use "${i}"?`))})}function Jo(t){_t(t).forEach(e=>er(e))}function Yo(t,e){let o=document.head.querySelector('script[src="'+t+'"][async]');return o||(o=document.createElement("script"),o.setAttribute("src",t),e===Et?o.setAttribute("type",Et):e===St&&o.setAttribute(St,""),o.async=!0),new Promise((i,r)=>{o.onreadystatechange=o.onload=n=>{o.__dynamicImportLoaded=!0,i(n)},o.onerror=n=>{o.parentNode&&o.parentNode.removeChild(o),r(n)},o.parentNode===null?document.head.appendChild(o):o.__dynamicImportLoaded&&i()})}function jr(t){return Z(t)?Yo(t):Promise.race(uo.filter(e=>e in t).map(e=>Yo(t[e],e)))}function We(t,e){return!window.dispatchEvent(new CustomEvent(`vaadin-router-${t}`,{cancelable:t==="go",detail:e}))}function kt(t){return typeof t=="object"&&!!t}function _e(t){return typeof t=="function"}function Z(t){return typeof t=="string"}function tr(t){const e=new Error(te(`Page not found (${t.pathname})`));return e.context=t,e.code=404,e}const Ne=new class{};function Ur(t){const e=t.port,o=t.protocol,n=o==="http:"&&e==="80"||o==="https:"&&e==="443"?t.hostname:t.host;return`${o}//${n}`}function Xo(t){if(t.defaultPrevented||t.button!==0||t.shiftKey||t.ctrlKey||t.altKey||t.metaKey)return;let e=t.target;const o=t.composedPath?t.composedPath():t.path||[];for(let l=0;l<o.length;l++){const a=o[l];if(a.nodeName&&a.nodeName.toLowerCase()==="a"){e=a;break}}for(;e&&e.nodeName.toLowerCase()!=="a";)e=e.parentNode;if(!e||e.nodeName.toLowerCase()!=="a"||e.target&&e.target.toLowerCase()!=="_self"||e.hasAttribute("download")||e.hasAttribute("router-ignore")||e.pathname===window.location.pathname&&e.hash!==""||(e.origin||Ur(e))!==window.location.origin)return;const{pathname:r,search:n,hash:s}=e;We("go",{pathname:r,search:n,hash:s})&&(t.preventDefault(),t&&t.type==="click"&&window.scrollTo(0,0))}const Fr={activate(){window.document.addEventListener("click",Xo)},inactivate(){window.document.removeEventListener("click",Xo)}},Br=/Trident/.test(navigator.userAgent);Br&&!_e(window.PopStateEvent)&&(window.PopStateEvent=function(t,e){e=e||{};var o=document.createEvent("Event");return o.initEvent(t,!!e.bubbles,!!e.cancelable),o.state=e.state||null,o},window.PopStateEvent.prototype=window.Event.prototype);function Qo(t){if(t.state==="vaadin-router-ignore")return;const{pathname:e,search:o,hash:i}=window.location;We("go",{pathname:e,search:o,hash:i})}const Hr={activate(){window.addEventListener("popstate",Qo)},inactivate(){window.removeEventListener("popstate",Qo)}};var Ue=ar,Wr=wo,qr=Yr,Gr=rr,Kr=sr,or="/",ir="./",Jr=new RegExp(["(\\\\.)","(?:\\:(\\w+)(?:\\(((?:\\\\.|[^\\\\()])+)\\))?|\\(((?:\\\\.|[^\\\\()])+)\\))([+*?])?"].join("|"),"g");function wo(t,e){for(var o=[],i=0,r=0,n="",s=e&&e.delimiter||or,l=e&&e.delimiters||ir,a=!1,c;(c=Jr.exec(t))!==null;){var d=c[0],h=c[1],u=c.index;if(n+=t.slice(r,u),r=u+d.length,h){n+=h[1],a=!0;continue}var y="",ne=t[r],G=c[2],nt=c[3],Bt=c[4],W=c[5];if(!a&&n.length){var ie=n.length-1;l.indexOf(n[ie])>-1&&(y=n[ie],n=n.slice(0,ie))}n&&(o.push(n),n="",a=!1);var Ce=y!==""&&ne!==void 0&&ne!==y,Te=W==="+"||W==="*",Ht=W==="?"||W==="*",se=y||s,st=nt||Bt;o.push({name:G||i++,prefix:y,delimiter:se,optional:Ht,repeat:Te,partial:Ce,pattern:st?Xr(st):"[^"+pe(se)+"]+?"})}return(n||r<t.length)&&o.push(n+t.substr(r)),o}function Yr(t,e){return rr(wo(t,e))}function rr(t){for(var e=new Array(t.length),o=0;o<t.length;o++)typeof t[o]=="object"&&(e[o]=new RegExp("^(?:"+t[o].pattern+")$"));return function(i,r){for(var n="",s=r&&r.encode||encodeURIComponent,l=0;l<t.length;l++){var a=t[l];if(typeof a=="string"){n+=a;continue}var c=i?i[a.name]:void 0,d;if(Array.isArray(c)){if(!a.repeat)throw new TypeError('Expected "'+a.name+'" to not repeat, but got array');if(c.length===0){if(a.optional)continue;throw new TypeError('Expected "'+a.name+'" to not be empty')}for(var h=0;h<c.length;h++){if(d=s(c[h],a),!e[l].test(d))throw new TypeError('Expected all "'+a.name+'" to match "'+a.pattern+'"');n+=(h===0?a.prefix:a.delimiter)+d}continue}if(typeof c=="string"||typeof c=="number"||typeof c=="boolean"){if(d=s(String(c),a),!e[l].test(d))throw new TypeError('Expected "'+a.name+'" to match "'+a.pattern+'", but got "'+d+'"');n+=a.prefix+d;continue}if(a.optional){a.partial&&(n+=a.prefix);continue}throw new TypeError('Expected "'+a.name+'" to be '+(a.repeat?"an array":"a string"))}return n}}function pe(t){return t.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1")}function Xr(t){return t.replace(/([=!:$/()])/g,"\\$1")}function nr(t){return t&&t.sensitive?"":"i"}function Qr(t,e){if(!e)return t;var o=t.source.match(/\((?!\?)/g);if(o)for(var i=0;i<o.length;i++)e.push({name:i,prefix:null,delimiter:null,optional:!1,repeat:!1,partial:!1,pattern:null});return t}function Zr(t,e,o){for(var i=[],r=0;r<t.length;r++)i.push(ar(t[r],e,o).source);return new RegExp("(?:"+i.join("|")+")",nr(o))}function en(t,e,o){return sr(wo(t,o),e,o)}function sr(t,e,o){o=o||{};for(var i=o.strict,r=o.start!==!1,n=o.end!==!1,s=pe(o.delimiter||or),l=o.delimiters||ir,a=[].concat(o.endsWith||[]).map(pe).concat("$").join("|"),c=r?"^":"",d=t.length===0,h=0;h<t.length;h++){var u=t[h];if(typeof u=="string")c+=pe(u),d=h===t.length-1&&l.indexOf(u[u.length-1])>-1;else{var y=u.repeat?"(?:"+u.pattern+")(?:"+pe(u.delimiter)+"(?:"+u.pattern+"))*":u.pattern;e&&e.push(u),u.optional?u.partial?c+=pe(u.prefix)+"("+y+")?":c+="(?:"+pe(u.prefix)+"("+y+"))?":c+=pe(u.prefix)+"("+y+")"}}return n?(i||(c+="(?:"+s+")?"),c+=a==="$"?"$":"(?="+a+")"):(i||(c+="(?:"+s+"(?="+a+"))?"),d||(c+="(?="+s+"|"+a+")")),new RegExp(c,nr(o))}function ar(t,e,o){return t instanceof RegExp?Qr(t,e):Array.isArray(t)?Zr(t,e,o):en(t,e,o)}Ue.parse=Wr;Ue.compile=qr;Ue.tokensToFunction=Gr;Ue.tokensToRegExp=Kr;const{hasOwnProperty:tn}=Object.prototype,po=new Map;po.set("|false",{keys:[],pattern:/(?:)/});function Zo(t){try{return decodeURIComponent(t)}catch{return t}}function on(t,e,o,i,r){o=!!o;const n=`${t}|${o}`;let s=po.get(n);if(!s){const c=[];s={keys:c,pattern:Ue(t,c,{end:o,strict:t===""})},po.set(n,s)}const l=s.pattern.exec(e);if(!l)return null;const a=Object.assign({},r);for(let c=1;c<l.length;c++){const d=s.keys[c-1],h=d.name,u=l[c];(u!==void 0||!tn.call(a,h))&&(d.repeat?a[h]=u?u.split(d.delimiter).map(Zo):[]:a[h]=u&&Zo(u))}return{path:l[0],keys:(i||[]).concat(s.keys),params:a}}function lr(t,e,o,i,r){let n,s,l=0,a=t.path||"";return a.charAt(0)==="/"&&(o&&(a=a.substr(1)),o=!0),{next(c){if(t===c)return{done:!0};const d=t.__children=t.__children||t.children;if(!n&&(n=on(a,e,!d,i,r),n))return{done:!1,value:{route:t,keys:n.keys,params:n.params,path:n.path}};if(n&&d)for(;l<d.length;){if(!s){const u=d[l];u.parent=t;let y=n.path.length;y>0&&e.charAt(y)==="/"&&(y+=1),s=lr(u,e.substr(y),o,n.keys,n.params)}const h=s.next(c);if(!h.done)return{done:!1,value:h.value};s=null,l++}return{done:!0}}}}function rn(t){if(_e(t.route.action))return t.route.action(t)}function nn(t,e){let o=e;for(;o;)if(o=o.parent,o===t)return!0;return!1}function sn(t){let e=`Path '${t.pathname}' is not properly resolved due to an error.`;const o=(t.route||{}).path;return o&&(e+=` Resolution had failed on route: '${o}'`),e}function an(t,e){const{route:o,path:i}=e;if(o&&!o.__synthetic){const r={path:i,route:o};if(!t.chain)t.chain=[];else if(o.parent){let n=t.chain.length;for(;n--&&t.chain[n].route&&t.chain[n].route!==o.parent;)t.chain.pop()}t.chain.push(r)}}class Ge{constructor(e,o={}){if(Object(e)!==e)throw new TypeError("Invalid routes");this.baseUrl=o.baseUrl||"",this.errorHandler=o.errorHandler,this.resolveRoute=o.resolveRoute||rn,this.context=Object.assign({resolver:this},o.context),this.root=Array.isArray(e)?{path:"",__children:e,parent:null,__synthetic:!0}:e,this.root.parent=null}getRoutes(){return[...this.root.__children]}setRoutes(e){Jo(e);const o=[..._t(e)];this.root.__children=o}addRoutes(e){return Jo(e),this.root.__children.push(..._t(e)),this.getRoutes()}removeRoutes(){this.setRoutes([])}resolve(e){const o=Object.assign({},this.context,Z(e)?{pathname:e}:e),i=lr(this.root,this.__normalizePathname(o.pathname),this.baseUrl),r=this.resolveRoute;let n=null,s=null,l=o;function a(c,d=n.value.route,h){const u=h===null&&n.value.route;return n=s||i.next(u),s=null,!c&&(n.done||!nn(d,n.value.route))?(s=n,Promise.resolve(Ne)):n.done?Promise.reject(tr(o)):(l=Object.assign(l?{chain:l.chain?l.chain.slice(0):[]}:{},o,n.value),an(l,n.value),Promise.resolve(r(l)).then(y=>y!=null&&y!==Ne?(l.result=y.result||y,l):a(c,d,y)))}return o.next=a,Promise.resolve().then(()=>a(!0,this.root)).catch(c=>{const d=sn(l);if(c?console.warn(d):c=new Error(d),c.context=c.context||l,c instanceof DOMException||(c.code=c.code||500),this.errorHandler)return l.result=this.errorHandler(c),l;throw c})}static __createUrl(e,o){return new URL(e,o)}get __effectiveBaseUrl(){return this.baseUrl?this.constructor.__createUrl(this.baseUrl,document.baseURI||document.URL).href.replace(/[^\/]*$/,""):""}__normalizePathname(e){if(!this.baseUrl)return e;const o=this.__effectiveBaseUrl,i=this.constructor.__createUrl(e,o).href;if(i.slice(0,o.length)===o)return i.slice(o.length)}}Ge.pathToRegexp=Ue;const{pathToRegexp:ei}=Ge,ti=new Map;function cr(t,e,o){const i=e.name||e.component;if(i&&(t.has(i)?t.get(i).push(e):t.set(i,[e])),Array.isArray(o))for(let r=0;r<o.length;r++){const n=o[r];n.parent=e,cr(t,n,n.__children||n.children)}}function oi(t,e){const o=t.get(e);if(o&&o.length>1)throw new Error(`Duplicate route with name "${e}". Try seting unique 'name' route properties.`);return o&&o[0]}function ii(t){let e=t.path;return e=Array.isArray(e)?e[0]:e,e!==void 0?e:""}function ln(t,e={}){if(!(t instanceof Ge))throw new TypeError("An instance of Resolver is expected");const o=new Map;return(i,r)=>{let n=oi(o,i);if(!n&&(o.clear(),cr(o,t.root,t.root.__children),n=oi(o,i),!n))throw new Error(`Route "${i}" not found`);let s=ti.get(n.fullPath);if(!s){let a=ii(n),c=n.parent;for(;c;){const y=ii(c);y&&(a=y.replace(/\/$/,"")+"/"+a.replace(/^\//,"")),c=c.parent}const d=ei.parse(a),h=ei.tokensToFunction(d),u=Object.create(null);for(let y=0;y<d.length;y++)Z(d[y])||(u[d[y].name]=!0);s={toPath:h,keys:u},ti.set(a,s),n.fullPath=a}let l=s.toPath(r,e)||"/";if(e.stringifyQueryParams&&r){const a={},c=Object.keys(r);for(let h=0;h<c.length;h++){const u=c[h];s.keys[u]||(a[u]=r[u])}const d=e.stringifyQueryParams(a);d&&(l+=d.charAt(0)==="?"?d:`?${d}`)}return l}}let ri=[];function cn(t){ri.forEach(e=>e.inactivate()),t.forEach(e=>e.activate()),ri=t}const dn=t=>{const e=getComputedStyle(t).getPropertyValue("animation-name");return e&&e!=="none"},un=(t,e)=>{const o=()=>{t.removeEventListener("animationend",o),e()};t.addEventListener("animationend",o)};function ni(t,e){return t.classList.add(e),new Promise(o=>{if(dn(t)){const i=t.getBoundingClientRect(),r=`height: ${i.bottom-i.top}px; width: ${i.right-i.left}px`;t.setAttribute("style",`position: absolute; ${r}`),un(t,()=>{t.classList.remove(e),t.removeAttribute("style"),o()})}else t.classList.remove(e),o()})}const pn=256;function Kt(t){return t!=null}function hn(t){const e=Object.assign({},t);return delete e.next,e}function K({pathname:t="",search:e="",hash:o="",chain:i=[],params:r={},redirectFrom:n,resolver:s},l){const a=i.map(c=>c.route);return{baseUrl:s&&s.baseUrl||"",pathname:t,search:e,hash:o,routes:a,route:l||a.length&&a[a.length-1]||null,params:r,redirectFrom:n,getUrl:(c={})=>ft(he.pathToRegexp.compile(dr(a))(Object.assign({},r,c)),s)}}function si(t,e){const o=Object.assign({},t.params);return{redirect:{pathname:e,from:t.pathname,params:o}}}function mn(t,e){e.location=K(t);const o=t.chain.map(i=>i.route).indexOf(t.route);return t.chain[o].element=e,e}function gt(t,e,o){if(_e(t))return t.apply(o,e)}function ai(t,e,o){return i=>{if(i&&(i.cancel||i.redirect))return i;if(o)return gt(o[t],e,o)}}function vn(t,e){if(!Array.isArray(t)&&!kt(t))throw new Error(te(`Incorrect "children" value for the route ${e.path}: expected array or object, but got ${t}`));e.__children=[];const o=_t(t);for(let i=0;i<o.length;i++)er(o[i]),e.__children.push(o[i])}function ut(t){if(t&&t.length){const e=t[0].parentNode;for(let o=0;o<t.length;o++)e.removeChild(t[o])}}function ft(t,e){const o=e.__effectiveBaseUrl;return o?e.constructor.__createUrl(t.replace(/^\//,""),o).pathname:t}function dr(t){return t.map(e=>e.path).reduce((e,o)=>o.length?e.replace(/\/$/,"")+"/"+o.replace(/^\//,""):e,"")}class he extends Ge{constructor(e,o){const i=document.head.querySelector("base"),r=i&&i.getAttribute("href");super([],Object.assign({baseUrl:r&&Ge.__createUrl(r,document.URL).pathname.replace(/[^\/]*$/,"")},o)),this.resolveRoute=s=>this.__resolveRoute(s);const n=he.NavigationTrigger;he.setTriggers.apply(he,Object.keys(n).map(s=>n[s])),this.baseUrl,this.ready,this.ready=Promise.resolve(e),this.location,this.location=K({resolver:this}),this.__lastStartedRenderId=0,this.__navigationEventHandler=this.__onNavigationEvent.bind(this),this.setOutlet(e),this.subscribe(),this.__createdByRouter=new WeakMap,this.__addedByRouter=new WeakMap}__resolveRoute(e){const o=e.route;let i=Promise.resolve();_e(o.children)&&(i=i.then(()=>o.children(hn(e))).then(n=>{!Kt(n)&&!_e(o.children)&&(n=o.children),vn(n,o)}));const r={redirect:n=>si(e,n),component:n=>{const s=document.createElement(n);return this.__createdByRouter.set(s,!0),s}};return i.then(()=>{if(this.__isLatestRender(e))return gt(o.action,[e,r],o)}).then(n=>{if(Kt(n)&&(n instanceof HTMLElement||n.redirect||n===Ne))return n;if(Z(o.redirect))return r.redirect(o.redirect);if(o.bundle)return jr(o.bundle).then(()=>{},()=>{throw new Error(te(`Bundle not found: ${o.bundle}. Check if the file name is correct`))})}).then(n=>{if(Kt(n))return n;if(Z(o.component))return r.component(o.component)})}setOutlet(e){e&&this.__ensureOutlet(e),this.__outlet=e}getOutlet(){return this.__outlet}setRoutes(e,o=!1){return this.__previousContext=void 0,this.__urlForName=void 0,super.setRoutes(e),o||this.__onNavigationEvent(),this.ready}render(e,o){const i=++this.__lastStartedRenderId,r=Object.assign({search:"",hash:""},Z(e)?{pathname:e}:e,{__renderId:i});return this.ready=this.resolve(r).then(n=>this.__fullyResolveChain(n)).then(n=>{if(this.__isLatestRender(n)){const s=this.__previousContext;if(n===s)return this.__updateBrowserHistory(s,!0),this.location;if(this.location=K(n),o&&this.__updateBrowserHistory(n,i===1),We("location-changed",{router:this,location:this.location}),n.__skipAttach)return this.__copyUnchangedElements(n,s),this.__previousContext=n,this.location;this.__addAppearingContent(n,s);const l=this.__animateIfNeeded(n);return this.__runOnAfterEnterCallbacks(n),this.__runOnAfterLeaveCallbacks(n,s),l.then(()=>{if(this.__isLatestRender(n))return this.__removeDisappearingContent(),this.__previousContext=n,this.location})}}).catch(n=>{if(i===this.__lastStartedRenderId)throw o&&this.__updateBrowserHistory(r),ut(this.__outlet&&this.__outlet.children),this.location=K(Object.assign(r,{resolver:this})),We("error",Object.assign({router:this,error:n},r)),n}),this.ready}__fullyResolveChain(e,o=e){return this.__findComponentContextAfterAllRedirects(o).then(i=>{const n=i!==o?i:e,l=ft(dr(i.chain),i.resolver)===i.pathname,a=(c,d=c.route,h)=>c.next(void 0,d,h).then(u=>u===null||u===Ne?l?c:d.parent!==null?a(c,d.parent,u):u:u);return a(i).then(c=>{if(c===null||c===Ne)throw tr(n);return c&&c!==Ne&&c!==i?this.__fullyResolveChain(n,c):this.__amendWithOnBeforeCallbacks(i)})})}__findComponentContextAfterAllRedirects(e){const o=e.result;return o instanceof HTMLElement?(mn(e,o),Promise.resolve(e)):o.redirect?this.__redirect(o.redirect,e.__redirectCount,e.__renderId).then(i=>this.__findComponentContextAfterAllRedirects(i)):o instanceof Error?Promise.reject(o):Promise.reject(new Error(te(`Invalid route resolution result for path "${e.pathname}". Expected redirect object or HTML element, but got: "${Dr(o)}". Double check the action return value for the route.`)))}__amendWithOnBeforeCallbacks(e){return this.__runOnBeforeCallbacks(e).then(o=>o===this.__previousContext||o===e?o:this.__fullyResolveChain(o))}__runOnBeforeCallbacks(e){const o=this.__previousContext||{},i=o.chain||[],r=e.chain;let n=Promise.resolve();const s=()=>({cancel:!0}),l=a=>si(e,a);if(e.__divergedChainIndex=0,e.__skipAttach=!1,i.length){for(let a=0;a<Math.min(i.length,r.length)&&!(i[a].route!==r[a].route||i[a].path!==r[a].path&&i[a].element!==r[a].element||!this.__isReusableElement(i[a].element,r[a].element));a=++e.__divergedChainIndex);if(e.__skipAttach=r.length===i.length&&e.__divergedChainIndex==r.length&&this.__isReusableElement(e.result,o.result),e.__skipAttach){for(let a=r.length-1;a>=0;a--)n=this.__runOnBeforeLeaveCallbacks(n,e,{prevent:s},i[a]);for(let a=0;a<r.length;a++)n=this.__runOnBeforeEnterCallbacks(n,e,{prevent:s,redirect:l},r[a]),i[a].element.location=K(e,i[a].route)}else for(let a=i.length-1;a>=e.__divergedChainIndex;a--)n=this.__runOnBeforeLeaveCallbacks(n,e,{prevent:s},i[a])}if(!e.__skipAttach)for(let a=0;a<r.length;a++)a<e.__divergedChainIndex?a<i.length&&i[a].element&&(i[a].element.location=K(e,i[a].route)):(n=this.__runOnBeforeEnterCallbacks(n,e,{prevent:s,redirect:l},r[a]),r[a].element&&(r[a].element.location=K(e,r[a].route)));return n.then(a=>{if(a){if(a.cancel)return this.__previousContext.__renderId=e.__renderId,this.__previousContext;if(a.redirect)return this.__redirect(a.redirect,e.__redirectCount,e.__renderId)}return e})}__runOnBeforeLeaveCallbacks(e,o,i,r){const n=K(o);return e.then(s=>{if(this.__isLatestRender(o))return ai("onBeforeLeave",[n,i,this],r.element)(s)}).then(s=>{if(!(s||{}).redirect)return s})}__runOnBeforeEnterCallbacks(e,o,i,r){const n=K(o,r.route);return e.then(s=>{if(this.__isLatestRender(o))return ai("onBeforeEnter",[n,i,this],r.element)(s)})}__isReusableElement(e,o){return e&&o?this.__createdByRouter.get(e)&&this.__createdByRouter.get(o)?e.localName===o.localName:e===o:!1}__isLatestRender(e){return e.__renderId===this.__lastStartedRenderId}__redirect(e,o,i){if(o>pn)throw new Error(te(`Too many redirects when rendering ${e.from}`));return this.resolve({pathname:this.urlForPath(e.pathname,e.params),redirectFrom:e.from,__redirectCount:(o||0)+1,__renderId:i})}__ensureOutlet(e=this.__outlet){if(!(e instanceof Node))throw new TypeError(te(`Expected router outlet to be a valid DOM Node (but got ${e})`))}__updateBrowserHistory({pathname:e,search:o="",hash:i=""},r){if(window.location.pathname!==e||window.location.search!==o||window.location.hash!==i){const n=r?"replaceState":"pushState";window.history[n](null,document.title,e+o+i),window.dispatchEvent(new PopStateEvent("popstate",{state:"vaadin-router-ignore"}))}}__copyUnchangedElements(e,o){let i=this.__outlet;for(let r=0;r<e.__divergedChainIndex;r++){const n=o&&o.chain[r].element;if(n)if(n.parentNode===i)e.chain[r].element=n,i=n;else break}return i}__addAppearingContent(e,o){this.__ensureOutlet(),this.__removeAppearingContent();const i=this.__copyUnchangedElements(e,o);this.__appearingContent=[],this.__disappearingContent=Array.from(i.children).filter(n=>this.__addedByRouter.get(n)&&n!==e.result);let r=i;for(let n=e.__divergedChainIndex;n<e.chain.length;n++){const s=e.chain[n].element;s&&(r.appendChild(s),this.__addedByRouter.set(s,!0),r===i&&this.__appearingContent.push(s),r=s)}}__removeDisappearingContent(){this.__disappearingContent&&ut(this.__disappearingContent),this.__disappearingContent=null,this.__appearingContent=null}__removeAppearingContent(){this.__disappearingContent&&this.__appearingContent&&(ut(this.__appearingContent),this.__disappearingContent=null,this.__appearingContent=null)}__runOnAfterLeaveCallbacks(e,o){if(o)for(let i=o.chain.length-1;i>=e.__divergedChainIndex&&this.__isLatestRender(e);i--){const r=o.chain[i].element;if(r)try{const n=K(e);gt(r.onAfterLeave,[n,{},o.resolver],r)}finally{this.__disappearingContent.indexOf(r)>-1&&ut(r.children)}}}__runOnAfterEnterCallbacks(e){for(let o=e.__divergedChainIndex;o<e.chain.length&&this.__isLatestRender(e);o++){const i=e.chain[o].element||{},r=K(e,e.chain[o].route);gt(i.onAfterEnter,[r,{},e.resolver],i)}}__animateIfNeeded(e){const o=(this.__disappearingContent||[])[0],i=(this.__appearingContent||[])[0],r=[],n=e.chain;let s;for(let l=n.length;l>0;l--)if(n[l-1].route.animate){s=n[l-1].route.animate;break}if(o&&i&&s){const l=kt(s)&&s.leave||"leaving",a=kt(s)&&s.enter||"entering";r.push(ni(o,l)),r.push(ni(i,a))}return Promise.all(r).then(()=>e)}subscribe(){window.addEventListener("vaadin-router-go",this.__navigationEventHandler)}unsubscribe(){window.removeEventListener("vaadin-router-go",this.__navigationEventHandler)}__onNavigationEvent(e){const{pathname:o,search:i,hash:r}=e?e.detail:window.location;Z(this.__normalizePathname(o))&&(e&&e.preventDefault&&e.preventDefault(),this.render({pathname:o,search:i,hash:r},!0))}static setTriggers(...e){cn(e)}urlForName(e,o){return this.__urlForName||(this.__urlForName=ln(this)),ft(this.__urlForName(e,o),this)}urlForPath(e,o){return ft(he.pathToRegexp.compile(e)(o),this)}static go(e){const{pathname:o,search:i,hash:r}=Z(e)?this.__createUrl(e,"http://a"):e;return We("go",{pathname:o,search:i,hash:r})}}const gn=/\/\*[\*!]\s+vaadin-dev-mode:start([\s\S]*)vaadin-dev-mode:end\s+\*\*\//i,bt=window.Vaadin&&window.Vaadin.Flow&&window.Vaadin.Flow.clients;function fn(){function t(){return!0}return ur(t)}function bn(){try{return yn()?!0:xn()?bt?!wn():!fn():!1}catch{return!1}}function yn(){return localStorage.getItem("vaadin.developmentmode.force")}function xn(){return["localhost","127.0.0.1"].indexOf(window.location.hostname)>=0}function wn(){return!!(bt&&Object.keys(bt).map(e=>bt[e]).filter(e=>e.productionMode).length>0)}function ur(t,e){if(typeof t!="function")return;const o=gn.exec(t.toString());if(o)try{t=new Function(o[1])}catch(i){console.log("vaadin-development-mode-detector: uncommentAndRun() failed",i)}return t(e)}window.Vaadin=window.Vaadin||{};const li=function(t,e){if(window.Vaadin.developmentMode)return ur(t,e)};window.Vaadin.developmentMode===void 0&&(window.Vaadin.developmentMode=bn());function _n(){}const En=function(){if(typeof li=="function")return li(_n)};window.Vaadin=window.Vaadin||{};window.Vaadin.registrations=window.Vaadin.registrations||[];window.Vaadin.registrations.push({is:"@vaadin/router",version:"1.7.4"});En();he.NavigationTrigger={POPSTATE:Hr,CLICK:Fr};var Jt,A;(function(t){t.CONNECTED="connected",t.LOADING="loading",t.RECONNECTING="reconnecting",t.CONNECTION_LOST="connection-lost"})(A||(A={}));class Sn{constructor(e){this.stateChangeListeners=new Set,this.loadingCount=0,this.connectionState=e,this.serviceWorkerMessageListener=this.serviceWorkerMessageListener.bind(this),navigator.serviceWorker&&(navigator.serviceWorker.addEventListener("message",this.serviceWorkerMessageListener),navigator.serviceWorker.ready.then(o=>{var i;(i=o.active)===null||i===void 0||i.postMessage({method:"Vaadin.ServiceWorker.isConnectionLost",id:"Vaadin.ServiceWorker.isConnectionLost"})}))}addStateChangeListener(e){this.stateChangeListeners.add(e)}removeStateChangeListener(e){this.stateChangeListeners.delete(e)}loadingStarted(){this.state=A.LOADING,this.loadingCount+=1}loadingFinished(){this.decreaseLoadingCount(A.CONNECTED)}loadingFailed(){this.decreaseLoadingCount(A.CONNECTION_LOST)}decreaseLoadingCount(e){this.loadingCount>0&&(this.loadingCount-=1,this.loadingCount===0&&(this.state=e))}get state(){return this.connectionState}set state(e){if(e!==this.connectionState){const o=this.connectionState;this.connectionState=e,this.loadingCount=0;for(const i of this.stateChangeListeners)i(o,this.connectionState)}}get online(){return this.connectionState===A.CONNECTED||this.connectionState===A.LOADING}get offline(){return!this.online}serviceWorkerMessageListener(e){typeof e.data=="object"&&e.data.id==="Vaadin.ServiceWorker.isConnectionLost"&&(e.data.result===!0&&(this.state=A.CONNECTION_LOST),navigator.serviceWorker.removeEventListener("message",this.serviceWorkerMessageListener))}}const kn=t=>!!(t==="localhost"||t==="[::1]"||/^127\.\d+\.\d+\.\d+$/u.exec(t)),pt=window;if(!(!((Jt=pt.Vaadin)===null||Jt===void 0)&&Jt.connectionState)){let t;kn(window.location.hostname)?t=!0:t=navigator.onLine,pt.Vaadin||(pt.Vaadin={}),pt.Vaadin.connectionState=new Sn(t?A.CONNECTED:A.CONNECTION_LOST)}function H(t,e,o,i){var r=arguments.length,n=r<3?e:i===null?i=Object.getOwnPropertyDescriptor(e,o):i,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")n=Reflect.decorate(t,e,o,i);else for(var l=t.length-1;l>=0;l--)(s=t[l])&&(n=(r<3?s(n):r>3?s(e,o,n):s(e,o))||n);return r>3&&n&&Object.defineProperty(e,o,n),n}/**
 * @license
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Cn=!1,yt=globalThis,_o=yt.ShadowRoot&&(yt.ShadyCSS===void 0||yt.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Eo=Symbol(),ci=new WeakMap;class So{constructor(e,o,i){if(this._$cssResult$=!0,i!==Eo)throw new Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this._strings=o}get styleSheet(){let e=this._styleSheet;const o=this._strings;if(_o&&e===void 0){const i=o!==void 0&&o.length===1;i&&(e=ci.get(o)),e===void 0&&((this._styleSheet=e=new CSSStyleSheet).replaceSync(this.cssText),i&&ci.set(o,e))}return e}toString(){return this.cssText}}const Tn=t=>{if(t._$cssResult$===!0)return t.cssText;if(typeof t=="number")return t;throw new Error(`Value passed to 'css' function must be a 'css' function result: ${t}. Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.`)},ko=t=>new So(typeof t=="string"?t:String(t),void 0,Eo),x=(t,...e)=>{const o=t.length===1?t[0]:e.reduce((i,r,n)=>i+Tn(r)+t[n+1],t[0]);return new So(o,t,Eo)},$n=(t,e)=>{if(_o)t.adoptedStyleSheets=e.map(o=>o instanceof CSSStyleSheet?o:o.styleSheet);else for(const o of e){const i=document.createElement("style"),r=yt.litNonce;r!==void 0&&i.setAttribute("nonce",r),i.textContent=o.cssText,t.appendChild(i)}},An=t=>{let e="";for(const o of t.cssRules)e+=o.cssText;return ko(e)},di=_o||Cn?t=>t:t=>t instanceof CSSStyleSheet?An(t):t;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:Rn,defineProperty:Pn,getOwnPropertyDescriptor:ui,getOwnPropertyNames:In,getOwnPropertySymbols:Nn,getPrototypeOf:pi}=Object,U=globalThis;let Q;const hi=U.trustedTypes,On=hi?hi.emptyScript:"",xt=U.reactiveElementPolyfillSupportDevMode;var Yi;{const t=U.litIssuedWarnings??(U.litIssuedWarnings=new Set);Q=(e,o)=>{o+=` See https://lit.dev/msg/${e} for more information.`,t.has(o)||(console.warn(o),t.add(o))},Q("dev-mode","Lit is in dev mode. Not recommended for production!"),(Yi=U.ShadyDOM)!=null&&Yi.inUse&&xt===void 0&&Q("polyfill-support-missing","Shadow DOM is being polyfilled via `ShadyDOM` but the `polyfill-support` module has not been loaded.")}const Yt=t=>{U.emitLitDebugLogEvents&&U.dispatchEvent(new CustomEvent("lit-debug",{detail:t}))},Oe=(t,e)=>t,Ct={toAttribute(t,e){switch(e){case Boolean:t=t?On:null;break;case Object:case Array:t=t==null?t:JSON.stringify(t);break}return t},fromAttribute(t,e){let o=t;switch(e){case Boolean:o=t!==null;break;case Number:o=t===null?null:Number(t);break;case Object:case Array:try{o=JSON.parse(t)}catch{o=null}break}return o}},Co=(t,e)=>!Rn(t,e),mi={attribute:!0,type:String,converter:Ct,reflect:!1,hasChanged:Co};Symbol.metadata??(Symbol.metadata=Symbol("metadata"));U.litPropertyMetadata??(U.litPropertyMetadata=new WeakMap);class ce extends HTMLElement{static addInitializer(e){this.__prepare(),(this._initializers??(this._initializers=[])).push(e)}static get observedAttributes(){return this.finalize(),this.__attributeToPropertyMap&&[...this.__attributeToPropertyMap.keys()]}static createProperty(e,o=mi){if(o.state&&(o.attribute=!1),this.__prepare(),this.elementProperties.set(e,o),!o.noAccessor){const i=Symbol.for(`${String(e)} (@property() cache)`),r=this.getPropertyDescriptor(e,i,o);r!==void 0&&Pn(this.prototype,e,r)}}static getPropertyDescriptor(e,o,i){const{get:r,set:n}=ui(this.prototype,e)??{get(){return this[o]},set(s){this[o]=s}};if(r==null){if("value"in(ui(this.prototype,e)??{}))throw new Error(`Field ${JSON.stringify(String(e))} on ${this.name} was declared as a reactive property but it's actually declared as a value on the prototype. Usually this is due to using @property or @state on a method.`);Q("reactive-property-without-getter",`Field ${JSON.stringify(String(e))} on ${this.name} was declared as a reactive property but it does not have a getter. This will be an error in a future version of Lit.`)}return{get(){return r==null?void 0:r.call(this)},set(s){const l=r==null?void 0:r.call(this);n.call(this,s),this.requestUpdate(e,l,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??mi}static __prepare(){if(this.hasOwnProperty(Oe("elementProperties")))return;const e=pi(this);e.finalize(),e._initializers!==void 0&&(this._initializers=[...e._initializers]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(Oe("finalized")))return;if(this.finalized=!0,this.__prepare(),this.hasOwnProperty(Oe("properties"))){const o=this.properties,i=[...In(o),...Nn(o)];for(const r of i)this.createProperty(r,o[r])}const e=this[Symbol.metadata];if(e!==null){const o=litPropertyMetadata.get(e);if(o!==void 0)for(const[i,r]of o)this.elementProperties.set(i,r)}this.__attributeToPropertyMap=new Map;for(const[o,i]of this.elementProperties){const r=this.__attributeNameForProperty(o,i);r!==void 0&&this.__attributeToPropertyMap.set(r,o)}this.elementStyles=this.finalizeStyles(this.styles),this.hasOwnProperty("createProperty")&&Q("no-override-create-property","Overriding ReactiveElement.createProperty() is deprecated. The override will not be called with standard decorators"),this.hasOwnProperty("getPropertyDescriptor")&&Q("no-override-get-property-descriptor","Overriding ReactiveElement.getPropertyDescriptor() is deprecated. The override will not be called with standard decorators")}static finalizeStyles(e){const o=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const r of i)o.unshift(di(r))}else e!==void 0&&o.push(di(e));return o}static __attributeNameForProperty(e,o){const i=o.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this.__instanceProperties=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this.__reflectingProperty=null,this.__initialize()}__initialize(){var e;this.__updatePromise=new Promise(o=>this.enableUpdating=o),this._$changedProperties=new Map,this.__saveInstanceProperties(),this.requestUpdate(),(e=this.constructor._initializers)==null||e.forEach(o=>o(this))}addController(e){var o;(this.__controllers??(this.__controllers=new Set)).add(e),this.renderRoot!==void 0&&this.isConnected&&((o=e.hostConnected)==null||o.call(e))}removeController(e){var o;(o=this.__controllers)==null||o.delete(e)}__saveInstanceProperties(){const e=new Map,o=this.constructor.elementProperties;for(const i of o.keys())this.hasOwnProperty(i)&&(e.set(i,this[i]),delete this[i]);e.size>0&&(this.__instanceProperties=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return $n(e,this.constructor.elementStyles),e}connectedCallback(){var e;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this.__controllers)==null||e.forEach(o=>{var i;return(i=o.hostConnected)==null?void 0:i.call(o)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this.__controllers)==null||e.forEach(o=>{var i;return(i=o.hostDisconnected)==null?void 0:i.call(o)})}attributeChangedCallback(e,o,i){this._$attributeToProperty(e,i)}__propertyToAttribute(e,o){var s;const r=this.constructor.elementProperties.get(e),n=this.constructor.__attributeNameForProperty(e,r);if(n!==void 0&&r.reflect===!0){const a=(((s=r.converter)==null?void 0:s.toAttribute)!==void 0?r.converter:Ct).toAttribute(o,r.type);this.constructor.enabledWarnings.includes("migration")&&a===void 0&&Q("undefined-attribute-value",`The attribute value for the ${e} property is undefined on element ${this.localName}. The attribute will be removed, but in the previous version of \`ReactiveElement\`, the attribute would not have changed.`),this.__reflectingProperty=e,a==null?this.removeAttribute(n):this.setAttribute(n,a),this.__reflectingProperty=null}}_$attributeToProperty(e,o){var n;const i=this.constructor,r=i.__attributeToPropertyMap.get(e);if(r!==void 0&&this.__reflectingProperty!==r){const s=i.getPropertyOptions(r),l=typeof s.converter=="function"?{fromAttribute:s.converter}:((n=s.converter)==null?void 0:n.fromAttribute)!==void 0?s.converter:Ct;this.__reflectingProperty=r,this[r]=l.fromAttribute(o,s.type),this.__reflectingProperty=null}}requestUpdate(e,o,i){if(e!==void 0){e instanceof Event&&Q("","The requestUpdate() method was called with an Event as the property name. This is probably a mistake caused by binding this.requestUpdate as an event listener. Instead bind a function that will call it with no arguments: () => this.requestUpdate()"),i??(i=this.constructor.getPropertyOptions(e));const r=i.hasChanged??Co,n=this[e];if(r(n,o))this._$changeProperty(e,o,i);else return}this.isUpdatePending===!1&&(this.__updatePromise=this.__enqueueUpdate())}_$changeProperty(e,o,i){this._$changedProperties.has(e)||this._$changedProperties.set(e,o),i.reflect===!0&&this.__reflectingProperty!==e&&(this.__reflectingProperties??(this.__reflectingProperties=new Set)).add(e)}async __enqueueUpdate(){this.isUpdatePending=!0;try{await this.__updatePromise}catch(o){Promise.reject(o)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){const e=this.performUpdate();return this.constructor.enabledWarnings.includes("async-perform-update")&&typeof(e==null?void 0:e.then)=="function"&&Q("async-perform-update",`Element ${this.localName} returned a Promise from performUpdate(). This behavior is deprecated and will be removed in a future version of ReactiveElement.`),e}performUpdate(){var i;if(!this.isUpdatePending)return;if(Yt==null||Yt({kind:"update"}),!this.hasUpdated){this.renderRoot??(this.renderRoot=this.createRenderRoot());{const s=[...this.constructor.elementProperties.keys()].filter(l=>this.hasOwnProperty(l)&&l in pi(this));if(s.length)throw new Error(`The following properties on element ${this.localName} will not trigger updates as expected because they are set using class fields: ${s.join(", ")}. Native class fields and some compiled output will overwrite accessors used for detecting changes. See https://lit.dev/msg/class-field-shadowing for more information.`)}if(this.__instanceProperties){for(const[n,s]of this.__instanceProperties)this[n]=s;this.__instanceProperties=void 0}const r=this.constructor.elementProperties;if(r.size>0)for(const[n,s]of r)s.wrapped===!0&&!this._$changedProperties.has(n)&&this[n]!==void 0&&this._$changeProperty(n,this[n],s)}let e=!1;const o=this._$changedProperties;try{e=this.shouldUpdate(o),e?(this.willUpdate(o),(i=this.__controllers)==null||i.forEach(r=>{var n;return(n=r.hostUpdate)==null?void 0:n.call(r)}),this.update(o)):this.__markUpdated()}catch(r){throw e=!1,this.__markUpdated(),r}e&&this._$didUpdate(o)}willUpdate(e){}_$didUpdate(e){var o;(o=this.__controllers)==null||o.forEach(i=>{var r;return(r=i.hostUpdated)==null?void 0:r.call(i)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e),this.isUpdatePending&&this.constructor.enabledWarnings.includes("change-in-update")&&Q("change-in-update",`Element ${this.localName} scheduled an update (generally because a property was set) after an update completed, causing a new update to be scheduled. This is inefficient and should be avoided unless the next update can only be scheduled as a side effect of the previous update.`)}__markUpdated(){this._$changedProperties=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this.__updatePromise}shouldUpdate(e){return!0}update(e){this.__reflectingProperties&&(this.__reflectingProperties=this.__reflectingProperties.forEach(o=>this.__propertyToAttribute(o,this[o]))),this.__markUpdated()}updated(e){}firstUpdated(e){}}ce.elementStyles=[];ce.shadowRootOptions={mode:"open"};ce[Oe("elementProperties")]=new Map;ce[Oe("finalized")]=new Map;xt==null||xt({ReactiveElement:ce});{ce.enabledWarnings=["change-in-update","async-perform-update"];const t=function(e){e.hasOwnProperty(Oe("enabledWarnings"))||(e.enabledWarnings=e.enabledWarnings.slice())};ce.enableWarning=function(e){t(this),this.enabledWarnings.includes(e)||this.enabledWarnings.push(e)},ce.disableWarning=function(e){t(this);const o=this.enabledWarnings.indexOf(e);o>=0&&this.enabledWarnings.splice(o,1)}}(U.reactiveElementVersions??(U.reactiveElementVersions=[])).push("2.0.4");U.reactiveElementVersions.length>1&&Q("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const M=globalThis,E=t=>{M.emitLitDebugLogEvents&&M.dispatchEvent(new CustomEvent("lit-debug",{detail:t}))};let Ln=0,Ke;M.litIssuedWarnings??(M.litIssuedWarnings=new Set),Ke=(t,e)=>{e+=t?` See https://lit.dev/msg/${t} for more information.`:"",M.litIssuedWarnings.has(e)||(console.warn(e),M.litIssuedWarnings.add(e))},Ke("dev-mode","Lit is in dev mode. Not recommended for production!");var Xi,Qi;const X=(Xi=M.ShadyDOM)!=null&&Xi.inUse&&((Qi=M.ShadyDOM)==null?void 0:Qi.noPatch)===!0?M.ShadyDOM.wrap:t=>t,Tt=M.trustedTypes,vi=Tt?Tt.createPolicy("lit-html",{createHTML:t=>t}):void 0,zn=t=>t,Ut=(t,e,o)=>zn,Mn=t=>{if(ke!==Ut)throw new Error("Attempted to overwrite existing lit-html security policy. setSanitizeDOMValueFactory should be called at most once.");ke=t},Vn=()=>{ke=Ut},ho=(t,e,o)=>ke(t,e,o),pr="$lit$",ae=`lit$${String(Math.random()).slice(9)}$`,hr="?"+ae,Dn=`<${hr}>`,Ee=document,Je=()=>Ee.createComment(""),Ye=t=>t===null||typeof t!="object"&&typeof t!="function",mr=Array.isArray,jn=t=>mr(t)||typeof(t==null?void 0:t[Symbol.iterator])=="function",Xt=`[ 	
\f\r]`,Un=`[^ 	
\f\r"'\`<>=]`,Fn=`[^\\s"'>=/]`,Fe=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,gi=1,Qt=2,Bn=3,fi=/-->/g,bi=/>/g,fe=new RegExp(`>|${Xt}(?:(${Fn}+)(${Xt}*=${Xt}*(?:${Un}|("|')|))|$)`,"g"),Hn=0,yi=1,Wn=2,xi=3,Zt=/'/g,eo=/"/g,vr=/^(?:script|style|textarea|title)$/i,qn=1,$t=2,To=1,At=2,Gn=3,Kn=4,Jn=5,$o=6,Yn=7,gr=t=>(e,...o)=>(e.some(i=>i===void 0)&&console.warn(`Some template strings are undefined.
...
Please use the static 'html' tag function. See https://lit.dev/docs/templates/expressions/#static-expressions`),{_$litType$:t,strings:e,values:o}),b=gr(qn),Ie=gr($t),Se=Symbol.for("lit-noChange"),$=Symbol.for("lit-nothing"),wi=new WeakMap,xe=Ee.createTreeWalker(Ee,129);let ke=Ut;function fr(t,e){if(!Array.isArray(t)||!t.hasOwnProperty("raw")){let o="invalid template strings array";throw o=`
        ...
        `.trim().replace(/\n */g,`
`),new Error(o)}return vi!==void 0?vi.createHTML(e):e}const Xn=(t,e)=>{const o=t.length-1,i=[];let r=e===$t?"<svg>":"",n,s=Fe;for(let a=0;a<o;a++){const c=t[a];let d=-1,h,u=0,y;for(;u<c.length&&(s.lastIndex=u,y=s.exec(c),y!==null);)if(u=s.lastIndex,s===Fe){if(y[gi]==="!--")s=fi;else if(y[gi]!==void 0)s=bi;else if(y[Qt]!==void 0)vr.test(y[Qt])&&(n=new RegExp(`</${y[Qt]}`,"g")),s=fe;else if(y[Bn]!==void 0)throw new Error("Bindings in tag names are not supported. Please use static templates instead. See https://lit.dev/docs/templates/expressions/#static-expressions")}else s===fe?y[Hn]===">"?(s=n??Fe,d=-1):y[yi]===void 0?d=-2:(d=s.lastIndex-y[Wn].length,h=y[yi],s=y[xi]===void 0?fe:y[xi]==='"'?eo:Zt):s===eo||s===Zt?s=fe:s===fi||s===bi?s=Fe:(s=fe,n=void 0);console.assert(d===-1||s===fe||s===Zt||s===eo,"unexpected parse state B");const ne=s===fe&&t[a+1].startsWith("/>")?" ":"";r+=s===Fe?c+Dn:d>=0?(i.push(h),c.slice(0,d)+pr+c.slice(d)+ae+ne):c+ae+(d===-2?a:ne)}const l=r+(t[o]||"<?>")+(e===$t?"</svg>":"");return[fr(t,l),i]};class Xe{constructor({strings:e,["_$litType$"]:o},i){this.parts=[];let r,n=0,s=0;const l=e.length-1,a=this.parts,[c,d]=Xn(e,o);if(this.el=Xe.createElement(c,i),xe.currentNode=this.el.content,o===$t){const h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(r=xe.nextNode())!==null&&a.length<l;){if(r.nodeType===1){{const h=r.localName;if(/^(?:textarea|template)$/i.test(h)&&r.innerHTML.includes(ae)){const u=`Expressions are not supported inside \`${h}\` elements. See https://lit.dev/msg/expression-in-${h} for more information.`;if(h==="template")throw new Error(u);Ke("",u)}}if(r.hasAttributes())for(const h of r.getAttributeNames())if(h.endsWith(pr)){const u=d[s++],ne=r.getAttribute(h).split(ae),G=/([.?@])?(.*)/.exec(u);a.push({type:To,index:n,name:G[2],strings:ne,ctor:G[1]==="."?Zn:G[1]==="?"?es:G[1]==="@"?ts:Ft}),r.removeAttribute(h)}else h.startsWith(ae)&&(a.push({type:$o,index:n}),r.removeAttribute(h));if(vr.test(r.tagName)){const h=r.textContent.split(ae),u=h.length-1;if(u>0){r.textContent=Tt?Tt.emptyScript:"";for(let y=0;y<u;y++)r.append(h[y],Je()),xe.nextNode(),a.push({type:At,index:++n});r.append(h[u],Je())}}}else if(r.nodeType===8)if(r.data===hr)a.push({type:At,index:n});else{let u=-1;for(;(u=r.data.indexOf(ae,u+1))!==-1;)a.push({type:Yn,index:n}),u+=ae.length-1}n++}if(d.length!==s)throw new Error('Detected duplicate attribute bindings. This occurs if your template has duplicate attributes on an element tag. For example "<input ?disabled=${true} ?disabled=${false}>" contains a duplicate "disabled" attribute. The error was detected in the following template: \n`'+e.join("${...}")+"`");E&&E({kind:"template prep",template:this,clonableTemplate:this.el,parts:this.parts,strings:e})}static createElement(e,o){const i=Ee.createElement("template");return i.innerHTML=e,i}}function ze(t,e,o=t,i){var s,l;if(e===Se)return e;let r=i!==void 0?(s=o.__directives)==null?void 0:s[i]:o.__directive;const n=Ye(e)?void 0:e._$litDirective$;return(r==null?void 0:r.constructor)!==n&&((l=r==null?void 0:r._$notifyDirectiveConnectionChanged)==null||l.call(r,!1),n===void 0?r=void 0:(r=new n(t),r._$initialize(t,o,i)),i!==void 0?(o.__directives??(o.__directives=[]))[i]=r:o.__directive=r),r!==void 0&&(e=ze(t,r._$resolve(t,e.values),r,i)),e}class Qn{constructor(e,o){this._$parts=[],this._$disconnectableChildren=void 0,this._$template=e,this._$parent=o}get parentNode(){return this._$parent.parentNode}get _$isConnected(){return this._$parent._$isConnected}_clone(e){const{el:{content:o},parts:i}=this._$template,r=((e==null?void 0:e.creationScope)??Ee).importNode(o,!0);xe.currentNode=r;let n=xe.nextNode(),s=0,l=0,a=i[0];for(;a!==void 0;){if(s===a.index){let c;a.type===At?c=new ot(n,n.nextSibling,this,e):a.type===To?c=new a.ctor(n,a.name,a.strings,this,e):a.type===$o&&(c=new os(n,this,e)),this._$parts.push(c),a=i[++l]}s!==(a==null?void 0:a.index)&&(n=xe.nextNode(),s++)}return xe.currentNode=Ee,r}_update(e){let o=0;for(const i of this._$parts)i!==void 0&&(E&&E({kind:"set part",part:i,value:e[o],valueIndex:o,values:e,templateInstance:this}),i.strings!==void 0?(i._$setValue(e,i,o),o+=i.strings.length-2):i._$setValue(e[o])),o++}}class ot{get _$isConnected(){var e;return((e=this._$parent)==null?void 0:e._$isConnected)??this.__isConnected}constructor(e,o,i,r){this.type=At,this._$committedValue=$,this._$disconnectableChildren=void 0,this._$startNode=e,this._$endNode=o,this._$parent=i,this.options=r,this.__isConnected=(r==null?void 0:r.isConnected)??!0,this._textSanitizer=void 0}get parentNode(){let e=X(this._$startNode).parentNode;const o=this._$parent;return o!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=o.parentNode),e}get startNode(){return this._$startNode}get endNode(){return this._$endNode}_$setValue(e,o=this){var i;if(this.parentNode===null)throw new Error("This `ChildPart` has no `parentNode` and therefore cannot accept a value. This likely means the element containing the part was manipulated in an unsupported way outside of Lit's control such that the part's marker nodes were ejected from DOM. For example, setting the element's `innerHTML` or `textContent` can do this.");if(e=ze(this,e,o),Ye(e))e===$||e==null||e===""?(this._$committedValue!==$&&(E&&E({kind:"commit nothing to child",start:this._$startNode,end:this._$endNode,parent:this._$parent,options:this.options}),this._$clear()),this._$committedValue=$):e!==this._$committedValue&&e!==Se&&this._commitText(e);else if(e._$litType$!==void 0)this._commitTemplateResult(e);else if(e.nodeType!==void 0){if(((i=this.options)==null?void 0:i.host)===e){this._commitText("[probable mistake: rendered a template's host in itself (commonly caused by writing ${this} in a template]"),console.warn("Attempted to render the template host",e,"inside itself. This is almost always a mistake, and in dev mode ","we render some warning text. In production however, we'll ","render it, which will usually result in an error, and sometimes ","in the element disappearing from the DOM.");return}this._commitNode(e)}else jn(e)?this._commitIterable(e):this._commitText(e)}_insert(e){return X(X(this._$startNode).parentNode).insertBefore(e,this._$endNode)}_commitNode(e){var o;if(this._$committedValue!==e){if(this._$clear(),ke!==Ut){const i=(o=this._$startNode.parentNode)==null?void 0:o.nodeName;if(i==="STYLE"||i==="SCRIPT"){let r="Forbidden";throw i==="STYLE"?r="Lit does not support binding inside style nodes. This is a security risk, as style injection attacks can exfiltrate data and spoof UIs. Consider instead using css`...` literals to compose styles, and make do dynamic styling with css custom properties, ::parts, <slot>s, and by mutating the DOM rather than stylesheets.":r="Lit does not support binding inside script nodes. This is a security risk, as it could allow arbitrary code execution.",new Error(r)}}E&&E({kind:"commit node",start:this._$startNode,parent:this._$parent,value:e,options:this.options}),this._$committedValue=this._insert(e)}}_commitText(e){if(this._$committedValue!==$&&Ye(this._$committedValue)){const o=X(this._$startNode).nextSibling;this._textSanitizer===void 0&&(this._textSanitizer=ho(o,"data","property")),e=this._textSanitizer(e),E&&E({kind:"commit text",node:o,value:e,options:this.options}),o.data=e}else{const o=Ee.createTextNode("");this._commitNode(o),this._textSanitizer===void 0&&(this._textSanitizer=ho(o,"data","property")),e=this._textSanitizer(e),E&&E({kind:"commit text",node:o,value:e,options:this.options}),o.data=e}this._$committedValue=e}_commitTemplateResult(e){var n;const{values:o,["_$litType$"]:i}=e,r=typeof i=="number"?this._$getTemplate(e):(i.el===void 0&&(i.el=Xe.createElement(fr(i.h,i.h[0]),this.options)),i);if(((n=this._$committedValue)==null?void 0:n._$template)===r)E&&E({kind:"template updating",template:r,instance:this._$committedValue,parts:this._$committedValue._$parts,options:this.options,values:o}),this._$committedValue._update(o);else{const s=new Qn(r,this),l=s._clone(this.options);E&&E({kind:"template instantiated",template:r,instance:s,parts:s._$parts,options:this.options,fragment:l,values:o}),s._update(o),E&&E({kind:"template instantiated and updated",template:r,instance:s,parts:s._$parts,options:this.options,fragment:l,values:o}),this._commitNode(l),this._$committedValue=s}}_$getTemplate(e){let o=wi.get(e.strings);return o===void 0&&wi.set(e.strings,o=new Xe(e)),o}_commitIterable(e){mr(this._$committedValue)||(this._$committedValue=[],this._$clear());const o=this._$committedValue;let i=0,r;for(const n of e)i===o.length?o.push(r=new ot(this._insert(Je()),this._insert(Je()),this,this.options)):r=o[i],r._$setValue(n),i++;i<o.length&&(this._$clear(r&&X(r._$endNode).nextSibling,i),o.length=i)}_$clear(e=X(this._$startNode).nextSibling,o){var i;for((i=this._$notifyConnectionChanged)==null||i.call(this,!1,!0,o);e&&e!==this._$endNode;){const r=X(e).nextSibling;X(e).remove(),e=r}}setConnected(e){var o;if(this._$parent===void 0)this.__isConnected=e,(o=this._$notifyConnectionChanged)==null||o.call(this,e);else throw new Error("part.setConnected() may only be called on a RootPart returned from render().")}}class Ft{get tagName(){return this.element.tagName}get _$isConnected(){return this._$parent._$isConnected}constructor(e,o,i,r,n){this.type=To,this._$committedValue=$,this._$disconnectableChildren=void 0,this.element=e,this.name=o,this._$parent=r,this.options=n,i.length>2||i[0]!==""||i[1]!==""?(this._$committedValue=new Array(i.length-1).fill(new String),this.strings=i):this._$committedValue=$,this._sanitizer=void 0}_$setValue(e,o=this,i,r){const n=this.strings;let s=!1;if(n===void 0)e=ze(this,e,o,0),s=!Ye(e)||e!==this._$committedValue&&e!==Se,s&&(this._$committedValue=e);else{const l=e;e=n[0];let a,c;for(a=0;a<n.length-1;a++)c=ze(this,l[i+a],o,a),c===Se&&(c=this._$committedValue[a]),s||(s=!Ye(c)||c!==this._$committedValue[a]),c===$?e=$:e!==$&&(e+=(c??"")+n[a+1]),this._$committedValue[a]=c}s&&!r&&this._commitValue(e)}_commitValue(e){e===$?X(this.element).removeAttribute(this.name):(this._sanitizer===void 0&&(this._sanitizer=ke(this.element,this.name,"attribute")),e=this._sanitizer(e??""),E&&E({kind:"commit attribute",element:this.element,name:this.name,value:e,options:this.options}),X(this.element).setAttribute(this.name,e??""))}}class Zn extends Ft{constructor(){super(...arguments),this.type=Gn}_commitValue(e){this._sanitizer===void 0&&(this._sanitizer=ke(this.element,this.name,"property")),e=this._sanitizer(e),E&&E({kind:"commit property",element:this.element,name:this.name,value:e,options:this.options}),this.element[this.name]=e===$?void 0:e}}class es extends Ft{constructor(){super(...arguments),this.type=Kn}_commitValue(e){E&&E({kind:"commit boolean attribute",element:this.element,name:this.name,value:!!(e&&e!==$),options:this.options}),X(this.element).toggleAttribute(this.name,!!e&&e!==$)}}class ts extends Ft{constructor(e,o,i,r,n){if(super(e,o,i,r,n),this.type=Jn,this.strings!==void 0)throw new Error(`A \`<${e.localName}>\` has a \`@${o}=...\` listener with invalid content. Event listeners in templates must have exactly one expression and no surrounding text.`)}_$setValue(e,o=this){if(e=ze(this,e,o,0)??$,e===Se)return;const i=this._$committedValue,r=e===$&&i!==$||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,n=e!==$&&(i===$||r);E&&E({kind:"commit event listener",element:this.element,name:this.name,value:e,options:this.options,removeListener:r,addListener:n,oldListener:i}),r&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,e),this._$committedValue=e}handleEvent(e){var o;typeof this._$committedValue=="function"?this._$committedValue.call(((o=this.options)==null?void 0:o.host)??this.element,e):this._$committedValue.handleEvent(e)}}class os{constructor(e,o,i){this.element=e,this.type=$o,this._$disconnectableChildren=void 0,this._$parent=o,this.options=i}get _$isConnected(){return this._$parent._$isConnected}_$setValue(e){E&&E({kind:"commit to element binding",element:this.element,value:e,options:this.options}),ze(this,e)}}const to=M.litHtmlPolyfillSupportDevMode;to==null||to(Xe,ot);(M.litHtmlVersions??(M.litHtmlVersions=[])).push("3.1.2");M.litHtmlVersions.length>1&&Ke("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.");const we=(t,e,o)=>{if(e==null)throw new TypeError(`The container to render into may not be ${e}`);const i=Ln++,r=(o==null?void 0:o.renderBefore)??e;let n=r._$litPart$;if(E&&E({kind:"begin render",id:i,value:t,container:e,options:o,part:n}),n===void 0){const s=(o==null?void 0:o.renderBefore)??null;r._$litPart$=n=new ot(e.insertBefore(Je(),s),s,void 0,o??{})}return n._$setValue(t),E&&E({kind:"end render",id:i,value:t,container:e,options:o,part:n}),n};we.setSanitizer=Mn,we.createSanitizer=ho,we._testOnlyClearSanitizerFactoryDoNotCallOrElse=Vn;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const is=(t,e)=>t;let br;{const t=globalThis.litIssuedWarnings??(globalThis.litIssuedWarnings=new Set);br=(e,o)=>{o+=` See https://lit.dev/msg/${e} for more information.`,t.has(o)||(console.warn(o),t.add(o))}}class P extends ce{constructor(){super(...arguments),this.renderOptions={host:this},this.__childPart=void 0}createRenderRoot(){var o;const e=super.createRenderRoot();return(o=this.renderOptions).renderBefore??(o.renderBefore=e.firstChild),e}update(e){const o=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this.__childPart=we(o,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this.__childPart)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this.__childPart)==null||e.setConnected(!1)}render(){return Se}}P._$litElement$=!0;P[is("finalized")]=!0;var Zi;(Zi=globalThis.litElementHydrateSupport)==null||Zi.call(globalThis,{LitElement:P});const oo=globalThis.litElementPolyfillSupportDevMode;oo==null||oo({LitElement:P});(globalThis.litElementVersions??(globalThis.litElementVersions=[])).push("4.0.4");globalThis.litElementVersions.length>1&&br("multiple-versions","Multiple versions of Lit loaded. Loading multiple versions is not recommended.");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let yr;{const t=globalThis.litIssuedWarnings??(globalThis.litIssuedWarnings=new Set);yr=(e,o)=>{o+=` See https://lit.dev/msg/${e} for more information.`,t.has(o)||(console.warn(o),t.add(o))}}const rs=(t,e,o)=>{const i=e.hasOwnProperty(o);return e.constructor.createProperty(o,i?{...t,wrapped:!0}:t),i?Object.getOwnPropertyDescriptor(e,o):void 0},ns={attribute:!0,type:String,converter:Ct,reflect:!1,hasChanged:Co},ss=(t=ns,e,o)=>{const{kind:i,metadata:r}=o;r==null&&yr("missing-class-metadata",`The class ${e} is missing decorator metadata. This could mean that you're using a compiler that supports decorators but doesn't support decorator metadata, such as TypeScript 5.1. Please update your compiler.`);let n=globalThis.litPropertyMetadata.get(r);if(n===void 0&&globalThis.litPropertyMetadata.set(r,n=new Map),n.set(o.name,t),i==="accessor"){const{name:s}=o;return{set(l){const a=e.get.call(this);e.set.call(this,l),this.requestUpdate(s,a,t)},init(l){return l!==void 0&&this._$changeProperty(s,void 0,t),l}}}else if(i==="setter"){const{name:s}=o;return function(l){const a=this[s];e.call(this,l),this.requestUpdate(s,a,t)}}throw new Error(`Unsupported decorator location: ${i}`)};function w(t){return(e,o)=>typeof o=="object"?ss(t,e,o):rs(t,e,o)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let xr;{const t=globalThis.litIssuedWarnings??(globalThis.litIssuedWarnings=new Set);xr=(e,o)=>{o+=e?` See https://lit.dev/msg/${e} for more information.`:"",t.has(o)||(console.warn(o),t.add(o))}}function it(t,e){return(o,i,r)=>{const n=s=>{var a;const l=((a=s.renderRoot)==null?void 0:a.querySelector(t))??null;if(l===null&&e&&!s.hasUpdated){const c=typeof i=="object"?i.name:i;xr("",`@query'd field ${JSON.stringify(String(c))} with the 'cache' flag set for selector '${t}' has been accessed before the first update and returned null. This is expected if the renderRoot tree has not been provided beforehand (e.g. via Declarative Shadow DOM). Therefore the value hasn't been cached.`)}return l};if(e){const{get:s,set:l}=typeof i=="object"?o:r??(()=>{const a=Symbol(`${String(i)} (@query() cache)`);return{get(){return this[a]},set(c){this[a]=c}}})();return _i(o,i,{get(){let a=s.call(this);return a===void 0&&(a=n(this),(a!==null||this.hasUpdated)&&l.call(this,a)),a}})}else return _i(o,i,{get(){return n(this)}})}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`,$s=(t,e)=>{const o=t[e];return o?typeof o=="function"?o():Promise.resolve(o):new Promise((i,r)=>{(typeof queueMicrotask=="function"?queueMicrotask:setTimeout)(r.bind(null,new Error("Unknown variable dynamic import: "+e)))})};var R;(function(t){t.text="text",t.checkbox="checkbox",t.range="range",t.color="color"})(R||(R={}));const oe={lumoSize:["--lumo-size-xs","--lumo-size-s","--lumo-size-m","--lumo-size-l","--lumo-size-xl"],lumoSpace:["--lumo-space-xs","--lumo-space-s","--lumo-space-m","--lumo-space-l","--lumo-space-xl"],lumoBorderRadius:["0","--lumo-border-radius-m","--lumo-border-radius-l"],lumoFontSize:["--lumo-font-size-xxs","--lumo-font-size-xs","--lumo-font-size-s","--lumo-font-size-m","--lumo-font-size-l","--lumo-font-size-xl","--lumo-font-size-xxl","--lumo-font-size-xxxl"],lumoTextColor:["--lumo-header-text-color","--lumo-body-text-color","--lumo-secondary-text-color","--lumo-tertiary-text-color","--lumo-disabled-text-color","--lumo-primary-text-color","--lumo-error-text-color","--lumo-success-text-color"],basicBorderSize:["0px","1px","2px","3px"]},As=Object.freeze(Object.defineProperty({__proto__:null,presets:oe},Symbol.toStringTag,{value:"Module"})),le={textColor:{propertyName:"color",displayName:"Text color",editorType:R.color,presets:oe.lumoTextColor},fontSize:{propertyName:"font-size",displayName:"Font size",editorType:R.range,presets:oe.lumoFontSize,icon:"font"},fontWeight:{propertyName:"font-weight",displayName:"Bold",editorType:R.checkbox,checkedValue:"bold"},fontStyle:{propertyName:"font-style",displayName:"Italic",editorType:R.checkbox,checkedValue:"italic"}},ee={backgroundColor:{propertyName:"background-color",displayName:"Background color",editorType:R.color},borderColor:{propertyName:"border-color",displayName:"Border color",editorType:R.color},borderWidth:{propertyName:"border-width",displayName:"Border width",editorType:R.range,presets:oe.basicBorderSize,icon:"square"},borderRadius:{propertyName:"border-radius",displayName:"Border radius",editorType:R.range,presets:oe.lumoBorderRadius,icon:"square"},padding:{propertyName:"padding",displayName:"Padding",editorType:R.range,presets:oe.lumoSpace,icon:"square"},gap:{propertyName:"gap",displayName:"Spacing",editorType:R.range,presets:oe.lumoSpace,icon:"square"}},Rs={height:{propertyName:"height",displayName:"Size",editorType:R.range,presets:oe.lumoSize,icon:"square"},paddingInline:{propertyName:"padding-inline",displayName:"Padding",editorType:R.range,presets:oe.lumoSpace,icon:"square"}},vo={iconColor:{propertyName:"color",displayName:"Icon color",editorType:R.color,presets:oe.lumoTextColor},iconSize:{propertyName:"font-size",displayName:"Icon size",editorType:R.range,presets:oe.lumoFontSize,icon:"font"}},Ps=[ee.backgroundColor,ee.borderColor,ee.borderWidth,ee.borderRadius,ee.padding],Is=[le.textColor,le.fontSize,le.fontWeight,le.fontStyle],Ns=[vo.iconColor,vo.iconSize],Os=Object.freeze(Object.defineProperty({__proto__:null,fieldProperties:Rs,iconProperties:vo,shapeProperties:ee,standardIconProperties:Ns,standardShapeProperties:Ps,standardTextProperties:Is,textProperties:le},Symbol.toStringTag,{value:"Module"}));function kr(t){const e=t.charAt(0).toUpperCase()+t.slice(1);return{tagName:t,displayName:e,elements:[{selector:t,displayName:"Element",properties:[ee.backgroundColor,ee.borderColor,ee.borderWidth,ee.borderRadius,ee.padding,le.textColor,le.fontSize,le.fontWeight,le.fontStyle]}]}}const Ls=Object.freeze(Object.defineProperty({__proto__:null,createGenericMetadata:kr},Symbol.toStringTag,{value:"Module"})),zs=t=>$s(Object.assign({"./components/defaults.ts":()=>g(()=>Promise.resolve().then(()=>Os),void 0),"./components/generic.ts":()=>g(()=>Promise.resolve().then(()=>Ls),void 0),"./components/presets.ts":()=>g(()=>Promise.resolve().then(()=>As),void 0),"./components/vaadin-accordion-heading.ts":()=>g(()=>f(()=>import("./vaadin-accordion-heading-c0acdd6d-D6Qf2rJ0.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-accordion-panel.ts":()=>g(()=>f(()=>import("./vaadin-accordion-panel-616e55d6-Cj4jKdVZ.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-accordion.ts":()=>g(()=>f(()=>import("./vaadin-accordion-eed3b794-PmNnGfYB.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-app-layout.ts":()=>g(()=>f(()=>import("./vaadin-app-layout-e56de2e9-Dil2tlqV.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-avatar.ts":()=>g(()=>f(()=>import("./vaadin-avatar-7599297d-uvoFtZhP.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-big-decimal-field.ts":()=>g(()=>f(()=>import("./vaadin-big-decimal-field-e51def24-e_0JBTFQ.js"),__vite__mapDeps([0,1,2]),import.meta.url),["assets/vaadin-big-decimal-field-e51def24.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-board-row.ts":()=>g(()=>f(()=>import("./vaadin-board-row-c70d0c55-jqjukRVI.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-board.ts":()=>g(()=>f(()=>import("./vaadin-board-828ebdea-CzllPnsf.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-button.ts":()=>g(()=>f(()=>import("./vaadin-button-2511ad84-66VvHaa1.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-chart.ts":()=>g(()=>f(()=>import("./vaadin-chart-5192dc15-CUtunVnR.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-checkbox-group.ts":()=>g(()=>f(()=>import("./vaadin-checkbox-group-a7c65bf2-DfkyZkx_.js"),__vite__mapDeps([3,1,4]),import.meta.url),["assets/vaadin-checkbox-group-a7c65bf2.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-checkbox-4e68df64.js"]),"./components/vaadin-checkbox.ts":()=>g(()=>f(()=>import("./vaadin-checkbox-4e68df64-DkXxjuI4.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-combo-box.ts":()=>g(()=>f(()=>import("./vaadin-combo-box-96451ddd-C04HfxSd.js"),__vite__mapDeps([5,1]),import.meta.url),["assets/vaadin-combo-box-96451ddd.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-confirm-dialog.ts":()=>g(()=>f(()=>import("./vaadin-confirm-dialog-4d718829-5TZkEokF.js"),__vite__mapDeps([6,2]),import.meta.url),["assets/vaadin-confirm-dialog-4d718829.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-cookie-consent.ts":()=>g(()=>f(()=>import("./vaadin-cookie-consent-46c09f8b-CaRtmAEd.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-crud.ts":()=>g(()=>f(()=>import("./vaadin-crud-8d161a22-DL4NDgjb.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-custom-field.ts":()=>g(()=>f(()=>import("./vaadin-custom-field-42c85b9e-CO7dheV3.js"),__vite__mapDeps([7,1]),import.meta.url),["assets/vaadin-custom-field-42c85b9e.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-date-picker.ts":()=>g(()=>f(()=>import("./vaadin-date-picker-f2001167-PjjOZGBy.js"),__vite__mapDeps([8,1]),import.meta.url),["assets/vaadin-date-picker-f2001167.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-date-time-picker.ts":()=>g(()=>f(()=>import("./vaadin-date-time-picker-c8c047a7-BG68xezH.js"),__vite__mapDeps([9,1]),import.meta.url),["assets/vaadin-date-time-picker-c8c047a7.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-details-summary.ts":()=>g(()=>f(()=>import("./vaadin-details-summary-351a1448-DDne21pW.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-details.ts":()=>g(()=>f(()=>import("./vaadin-details-bf336660-Cu6sEh3Q.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-dialog.ts":()=>g(()=>f(()=>import("./vaadin-dialog-53253a08-CtCoo7KL.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-email-field.ts":()=>g(()=>f(()=>import("./vaadin-email-field-d7a35f04-CQQ2Zylu.js"),__vite__mapDeps([10,1,2]),import.meta.url),["assets/vaadin-email-field-d7a35f04.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-form-layout.ts":()=>g(()=>f(()=>import("./vaadin-form-layout-47744b1d-BAyVxuKx.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-grid-pro.ts":()=>g(()=>f(()=>import("./vaadin-grid-pro-ff415555-Dp1b65jW.js"),__vite__mapDeps([11,4,12,1]),import.meta.url),["assets/vaadin-grid-pro-ff415555.js","assets/vaadin-checkbox-4e68df64.js","assets/vaadin-grid-0a4791c2.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-grid.ts":()=>g(()=>f(()=>import("./vaadin-grid-0a4791c2-7x0JA_PF.js"),__vite__mapDeps([12,4]),import.meta.url),["assets/vaadin-grid-0a4791c2.js","assets/vaadin-checkbox-4e68df64.js"]),"./components/vaadin-horizontal-layout.ts":()=>g(()=>f(()=>import("./vaadin-horizontal-layout-3193943f-B5JX-v5t.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-icon.ts":()=>g(()=>f(()=>import("./vaadin-icon-601f36ed-5q6Ojdom.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-integer-field.ts":()=>g(()=>f(()=>import("./vaadin-integer-field-85078932-Bo9DO0Pa.js"),__vite__mapDeps([13,1,2]),import.meta.url),["assets/vaadin-integer-field-85078932.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-list-box.ts":()=>g(()=>f(()=>import("./vaadin-list-box-d7a8433b-B210NFbd.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-login-form.ts":()=>g(()=>f(()=>import("./vaadin-login-form-638996c6-Bi7ZKdN6.js"),__vite__mapDeps([14,1,2]),import.meta.url),["assets/vaadin-login-form-638996c6.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-login-overlay.ts":()=>g(()=>f(()=>import("./vaadin-login-overlay-f8a5db8a-C39yHOr6.js"),__vite__mapDeps([15,1,2]),import.meta.url),["assets/vaadin-login-overlay-f8a5db8a.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-map.ts":()=>g(()=>f(()=>import("./vaadin-map-d40a0116-Bamn-1pe.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-menu-bar.ts":()=>g(()=>f(()=>import("./vaadin-menu-bar-3f5ab096-D4X7zhI_.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-message-input.ts":()=>g(()=>f(()=>import("./vaadin-message-input-996ac37c-_OV1OyN-.js"),__vite__mapDeps([16,1]),import.meta.url),["assets/vaadin-message-input-996ac37c.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-message-list.ts":()=>g(()=>f(()=>import("./vaadin-message-list-70a435ba-ZfX15cGF.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-multi-select-combo-box.ts":()=>g(()=>f(()=>import("./vaadin-multi-select-combo-box-a3373557-Bps9uIFG.js"),__vite__mapDeps([17,1]),import.meta.url),["assets/vaadin-multi-select-combo-box-a3373557.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-notification.ts":()=>g(()=>f(()=>import("./vaadin-notification-bd6eb776-dx6a8sSj.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-number-field.ts":()=>g(()=>f(()=>import("./vaadin-number-field-cb3ee8b2-DK5wdbVG.js"),__vite__mapDeps([18,1,2]),import.meta.url),["assets/vaadin-number-field-cb3ee8b2.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-password-field.ts":()=>g(()=>f(()=>import("./vaadin-password-field-d289cb18-CTuD773y.js"),__vite__mapDeps([19,1,2]),import.meta.url),["assets/vaadin-password-field-d289cb18.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-progress-bar.ts":()=>g(()=>f(()=>import("./vaadin-progress-bar-309ecf1f-DY87SQhU.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-radio-group.ts":()=>g(()=>f(()=>import("./vaadin-radio-group-88b5afd8-DfGNY-gA.js"),__vite__mapDeps([20,1]),import.meta.url),["assets/vaadin-radio-group-88b5afd8.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-rich-text-editor.ts":()=>g(()=>f(()=>import("./vaadin-rich-text-editor-8cd892f2-DFbItRVG.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-scroller.ts":()=>g(()=>f(()=>import("./vaadin-scroller-35e68818-Dq-VH1q0.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-select.ts":()=>g(()=>f(()=>import("./vaadin-select-df6e9947-CKC4v5_c.js"),__vite__mapDeps([21,1]),import.meta.url),["assets/vaadin-select-df6e9947.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-side-nav-item.ts":()=>g(()=>f(()=>import("./vaadin-side-nav-item-34918f92-BTFZKIlK.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-side-nav.ts":()=>g(()=>f(()=>import("./vaadin-side-nav-ba80d91d-DVkjlkvC.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-split-layout.ts":()=>g(()=>f(()=>import("./vaadin-split-layout-80c92131-CIvx_ebl.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-spreadsheet.ts":()=>g(()=>f(()=>import("./vaadin-spreadsheet-59d8c5ef-Cn7l1O9z.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-tab.ts":()=>g(()=>f(()=>import("./vaadin-tab-aaf32809-0AL_FRas.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-tabs.ts":()=>g(()=>f(()=>import("./vaadin-tabs-d9a5e24e-DsCtg35k.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-tabsheet.ts":()=>g(()=>f(()=>import("./vaadin-tabsheet-dd99ed9a-Bf-sVjYD.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-text-area.ts":()=>g(()=>f(()=>import("./vaadin-text-area-83627ebc-D_yBoy15.js"),__vite__mapDeps([22,1,2]),import.meta.url),["assets/vaadin-text-area-83627ebc.js","assets/vaadin-text-field-0b3db014.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-text-field.ts":()=>g(()=>f(()=>import("./vaadin-text-field-0b3db014-U4agpn8T.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-time-picker.ts":()=>g(()=>f(()=>import("./vaadin-time-picker-715ec415-C2T-qfDG.js"),__vite__mapDeps([23,1]),import.meta.url),["assets/vaadin-time-picker-715ec415.js","assets/vaadin-text-field-0b3db014.js"]),"./components/vaadin-upload.ts":()=>g(()=>f(()=>import("./vaadin-upload-d3c162ed-1ocxF_zJ.js"),__vite__mapDeps([24,2]),import.meta.url),["assets/vaadin-upload-d3c162ed.js","assets/vaadin-button-2511ad84.js"]),"./components/vaadin-vertical-layout.ts":()=>g(()=>f(()=>import("./vaadin-vertical-layout-ad4174c4-BW-3qG9W.js"),__vite__mapDeps([]),import.meta.url),[]),"./components/vaadin-virtual-list.ts":()=>g(()=>f(()=>import("./vaadin-virtual-list-96896203-CtEMI31g.js"),__vite__mapDeps([]),import.meta.url),[])}),`./components/${t}.ts`);class Ms{constructor(e=zs){this.loader=e,this.metadata={}}async getMetadata(e){var o;const i=(o=e.element)==null?void 0:o.localName;if(!i)return null;if(!i.startsWith("vaadin-"))return kr(i);let r=this.metadata[i];if(r)return r;try{r=(await this.loader(i)).default,this.metadata[i]=r}catch{console.warn(`Failed to load metadata for component: ${i}`)}return r||null}}const Vs=new Ms,wt={crosshair:Ie`<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
...
</svg>`};var Ve;(function(t){t.disabled="disabled",t.enabled="enabled",t.missing_theme="missing_theme"})(Ve||(Ve={}));var N;(function(t){t.local="local",t.global="global"})(N||(N={}));function ro(t,e){return`${t}|${e}`}class me{constructor(e){this._properties={},this._metadata=e}get metadata(){return this._metadata}get properties(){return Object.values(this._properties)}getPropertyValue(e,o){return this._properties[ro(e,o)]||null}updatePropertyValue(e,o,i,r){if(!i){delete this._properties[ro(e,o)];return}let n=this.getPropertyValue(e,o);n?(n.value=i,n.modified=r||!1):(n={elementSelector:e,propertyName:o,value:i,modified:r||!1},this._properties[ro(e,o)]=n)}addPropertyValues(e){e.forEach(o=>{this.updatePropertyValue(o.elementSelector,o.propertyName,o.value,o.modified)})}getPropertyValuesForElement(e){return this.properties.filter(o=>o.elementSelector===e)}static combine(...e){if(e.length<2)throw new Error("Must provide at least two themes");const o=new me(e[0].metadata);return e.forEach(i=>o.addPropertyValues(i.properties)),o}static fromServerRules(e,o,i){const r=new me(e);return e.elements.forEach(n=>{const s=De(n,o),l=i.find(a=>a.selector===s.replace(/ > /g,">"));l&&n.properties.forEach(a=>{const c=l.properties[a.propertyName];c&&r.updatePropertyValue(n.selector,a.propertyName,c,!0)})}),r}}function De(t,e){const o=t.selector;if(e.themeScope===N.global)return o;if(!e.localClassName)throw new Error("Can not build local scoped selector without instance class name");const i=o.match(/^[\w\d-_]+/),r=i&&i[0];if(!r)throw new Error(`Selector does not start with a tag name: ${o}`);return`${r}.${e.localClassName}${o.substring(r.length,o.length)}`}function Ds(t,e,o,i){const r=De(t,e),n={[o]:i};return o==="border-width"&&(parseInt(i)>0?n["border-style"]="solid":n["border-style"]=""),{selector:r,properties:n}}function js(t){const e=Object.entries(t.properties).map(([o,i])=>`${o}: ${i};`).join(" ");return`${t.selector} { ${e} }`}let mt,Ri="";function Io(t){mt||(mt=new CSSStyleSheet,document.adoptedStyleSheets=[...document.adoptedStyleSheets,mt]),Ri+=t.cssText,mt.replaceSync(Ri)}const Cr=x`
  .editor-row {
    display: flex;
...
`);async function Us(t){const e=new me(t),o=document.createElement(t.tagName);o.classList.add(Pi),document.body.append(o),t.setupElement&&await t.setupElement(o);const i={themeScope:N.local,localClassName:Pi};try{t.elements.forEach(r=>{Oi(o,r,i,!0);let n=De(r,i);const s=n.match(Ii);n=n.replace(Ii,"");const l=n.match(Ni),a=n.replace(Ni,"");let c=document.querySelector(a);if(c&&l){const u=`[part~="${l[1]}"]`;c=c.shadowRoot.querySelector(u)}if(!c)return;c.style.transition="none";const d=s?s[1]:null,h=getComputedStyle(c,d);r.properties.forEach(u=>{const y=h.getPropertyValue(u.propertyName)||u.defaultValue||"";e.updatePropertyValue(r.selector,u.propertyName,y)}),Oi(o,r,i,!1)})}finally{try{t.cleanupElement&&await t.cleanupElement(o)}finally{o.remove()}}return e}function Oi(t,e,o,i){if(e.stateAttribute){if(e.stateElementSelector){const r=De({...e,selector:e.stateElementSelector},o);t=document.querySelector(r)}t&&(i?t.setAttribute(e.stateAttribute,""):t.removeAttribute(e.stateAttribute))}}function Li(t){return t.trim()}function Fs(t){const e=t.element;if(!e)return null;const o=e.querySelector("label");if(o&&o.textContent)return Li(o.textContent);const i=e.textContent;return i?Li(i):null}class Bs{constructor(){this._localClassNameMap=new Map}get stylesheet(){return this.ensureStylesheet(),this._stylesheet}add(e){this.ensureStylesheet(),this._stylesheet.replaceSync(e)}clear(){this.ensureStylesheet(),this._stylesheet.replaceSync("")}previewLocalClassName(e,o){if(!e)return;const i=this._localClassNameMap.get(e);i&&(e.classList.remove(i),e.overlayClass=null),o?(e.classList.add(o),e.overlayClass=o,this._localClassNameMap.set(e,o)):this._localClassNameMap.delete(e)}ensureStylesheet(){this._stylesheet||(this._stylesheet=new CSSStyleSheet,this._stylesheet.replaceSync(""),document.adoptedStyleSheets=[...document.adoptedStyleSheets,this._stylesheet])}}const be=new Bs;var Y;(function(t){t.response="themeEditorResponse",t.loadComponentMetadata="themeEditorComponentMetadata",t.setLocalClassName="themeEditorLocalClassName",t.setCssRules="themeEditorRules",t.loadRules="themeEditorLoadRules",t.history="themeEditorHistory",t.openCss="themeEditorOpenCss",t.markAsUsed="themeEditorMarkAsUsed"})(Y||(Y={}));var go;(function(t){t.ok="ok",t.error="error"})(go||(go={}));class Hs{constructor(e){this.pendingRequests={},this.requestCounter=0,this.wrappedConnection=e;const o=this.wrappedConnection.onMessage;this.wrappedConnection.onMessage=i=>{i.command===Y.response?this.handleResponse(i.data):o.call(this.wrappedConnection,i)}}sendRequest(e,o){const i=(this.requestCounter++).toString(),r=o.uiId??this.getGlobalUiId();return new Promise((n,s)=>{this.wrappedConnection.send(e,{...o,requestId:i,uiId:r}),this.pendingRequests[i]={resolve:n,reject:s}})}handleResponse(e){const o=this.pendingRequests[e.requestId];if(!o){console.warn("Received response for unknown request");return}delete this.pendingRequests[e.requestId],e.code===go.ok?o.resolve(e):o.reject(e)}loadComponentMetadata(e){return this.sendRequest(Y.loadComponentMetadata,{nodeId:e.nodeId})}setLocalClassName(e,o){return this.sendRequest(Y.setLocalClassName,{nodeId:e.nodeId,className:o})}setCssRules(e){return this.sendRequest(Y.setCssRules,{rules:e})}loadRules(e){return this.sendRequest(Y.loadRules,{selectors:e})}markAsUsed(){return this.sendRequest(Y.markAsUsed,{})}undo(e){return this.sendRequest(Y.history,{undo:e})}redo(e){return this.sendRequest(Y.history,{redo:e})}openCss(e){return this.sendRequest(Y.openCss,{selector:e})}getGlobalUiId(){if(this.globalUiId===void 0){const e=window.Vaadin;if(e&&e.Flow){const{clients:o}=e.Flow,i=Object.keys(o);for(const r of i){const n=o[r];if(n.getNodeId){this.globalUiId=n.getUIId();break}}}}return this.globalUiId??-1}}const z={index:-1,entries:[]};class Ws{constructor(e){this.api=e}get allowUndo(){return z.index>=0}get allowRedo(){return z.index<z.entries.length-1}get allowedActions(){return{allowUndo:this.allowUndo,allowRedo:this.allowRedo}}push(e,o,i){const r={requestId:e,execute:o,rollback:i};if(z.index++,z.entries=z.entries.slice(0,z.index),z.entries.push(r),o)try{o()}catch(n){console.error("Execute history entry failed",n)}return this.allowedActions}async undo(){if(!this.allowUndo)return this.allowedActions;const e=z.entries[z.index];z.index--;try{await this.api.undo(e.requestId),e.rollback&&e.rollback()}catch(o){console.error("Undo failed",o)}return this.allowedActions}async redo(){if(!this.allowRedo)return this.allowedActions;z.index++;const e=z.entries[z.index];try{await this.api.redo(e.requestId),e.execute&&e.execute()}catch(o){console.error("Redo failed",o)}return this.allowedActions}static clear(){z.entries=[],z.index=-1}}class qs extends CustomEvent{constructor(e,o,i){super("theme-property-value-change",{bubbles:!0,composed:!0,detail:{element:e,property:o,value:i}})}}class q extends P{constructor(){super(...arguments),this.value=""}static get styles(){return[Cr,x`
    ...
    `}handleInputChange(t){const e=t.target;this.dispatchEvent(new zi(e.value))}handleClearClick(){this.dispatchEvent(new zi(""))}};v([w({})],Nt.prototype,"value",void 0);v([w({})],Nt.prototype,"showClearButton",void 0);Nt=v([V("vaadin-dev-tools-theme-text-input")],Nt);class Gs extends CustomEvent{constructor(e){super("class-name-change",{detail:{value:e}})}}let Ze=class extends P{constructor(){super(...arguments),this.editedClassName="",this.invalid=!1}static get styles(){return[Cr,x`
        .editor-row {
          padding-top: 0;
        }
    ...
    </div>`}handleInputChange(t){this.editedClassName=t.detail.value;const e=/^-?[_a-zA-Z]+[_a-zA-Z0-9-]*$/;this.invalid=!this.editedClassName.match(e),!this.invalid&&this.editedClassName!==this.className&&this.dispatchEvent(new Gs(this.editedClassName))}};v([w({})],Ze.prototype,"className",void 0);v([I()],Ze.prototype,"editedClassName",void 0);v([I()],Ze.prototype,"invalid",void 0);Ze=v([V("vaadin-dev-tools-theme-class-name-editor")],Ze);class Ks extends CustomEvent{constructor(e){super("scope-change",{detail:{value:e}})}}Io(x`
...
`);let et=class extends P{constructor(){super(...arguments),this.value=N.local}static get styles(){return x`
    ...
    ></vaadin-select>`}selectRenderer(t){var e;const o=((e=this.metadata)==null?void 0:e.displayName)||"Component",i=`${o}s`;we(b`
      ...
      `,t)}handleValueChange(t){const e=t.detail.value;e!==this.value&&this.dispatchEvent(new Ks(e))}};v([w({})],et.prototype,"value",void 0);v([w({})],et.prototype,"metadata",void 0);v([it("vaadin-select")],et.prototype,"select",void 0);et=v([V("vaadin-dev-tools-theme-scope-selector")],et);let Mi=class extends q{static get styles(){return[q.styles,x`
        .editor-row {
          align-items: center;
        }
      `]}handleInputChange(t){const e=t.target.checked?this.propertyMetadata.checkedValue:"";this.dispatchChange(e||"")}renderEditor(){const t=this.value===this.propertyMetadata.checkedValue;return b` <input type="checkbox" .checked=${t} @change=${this.handleInputChange} /> `}};Mi=v([V("vaadin-dev-tools-theme-checkbox-property-editor")],Mi);let Vi=class extends q{handleInputChange(t){this.dispatchChange(t.detail.value)}renderEditor(){var t;return b`
      <vaadin-dev-tools-theme-text-input
        .value=${this.value}
        .showClearButton=${((t=this.propertyValue)==null?void 0:t.modified)||!1}
        @change=${this.handleInputChange}
      ></vaadin-dev-tools-theme-text-input>
    `}};Vi=v([V("vaadin-dev-tools-theme-text-property-editor")],Vi);let Ot=class extends q{constructor(){super(...arguments),this.selectedPresetIndex=-1,this.presets=new It}static get styles(){return[q.styles,x`
        :host {
          --preset-count: 3;
          --slider-bg: #fff;
          --slider-border: #333;
      ...
      ></vaadin-dev-tools-theme-text-input>
    `}handleSliderInput(t){const e=t.target,o=parseInt(e.value),i=this.presets.values[o];this.selectedPresetIndex=o,this.value=this.presets.rawValues[i]}handleSliderChange(){this.dispatchChange(this.value)}handleValueChange(t){this.value=t.detail.value,this.updateSliderValue(),this.dispatchChange(this.value)}dispatchChange(t){const e=this.presets.tryMapToPreset(t);super.dispatchChange(e)}updateValueFromTheme(){var t;super.updateValueFromTheme(),this.value=this.presets.tryMapToRawValue(((t=this.propertyValue)==null?void 0:t.value)||""),this.updateSliderValue()}updateSliderValue(){const t=this.presets.findPreset(this.value);this.selectedPresetIndex=t?this.presets.values.indexOf(t):-1}};v([I()],Ot.prototype,"selectedPresetIndex",void 0);v([I()],Ot.prototype,"presets",void 0);Ot=v([V("vaadin-dev-tools-theme-range-property-editor")],Ot);const je=(t,e=0,o=1)=>t>o?o:t<e?e:t,F=(t,e=0,o=Math.pow(10,e))=>Math.round(o*t)/o,Tr=({h:t,s:e,v:o,a:i})=>{const r=(200-e)*o/100;return{h:F(t),s:F(r>0&&r<200?e*o/100/(r<=100?r:200-r)*100:0),l:F(r/2),a:F(i,2)}},fo=t=>{const{h:e,s:o,l:i}=Tr(t);return`hsl(${e}, ${o}%, ${i}%)`},no=t=>{const{h:e,s:o,l:i,a:r}=Tr(t);return`hsla(${e}, ${o}%, ${i}%, ${r})`},Js=({h:t,s:e,v:o,a:i})=>{t=t/360*6,e=e/100,o=o/100;const r=Math.floor(t),n=o*(1-e),s=o*(1-(t-r)*e),l=o*(1-(1-t+r)*e),a=r%6;return{r:F([o,s,n,n,l,o][a]*255),g:F([l,o,o,s,n,n][a]*255),b:F([n,n,l,o,o,s][a]*255),a:F(i,2)}},Ys=t=>{const{r:e,g:o,b:i,a:r}=Js(t);return`rgba(${e}, ${o}, ${i}, ${r})`},Xs=t=>{const e=/rgba?\(?\s*(-?\d*\.?\d+)(%)?[,\s]+(-?\d*\.?\d+)(%)?[,\s]+(-?\d*\.?\d+)(%)?,?\s*[/\s]*(-?\d*\.?\d+)?(%)?\s*\)?/i.exec(t);return e?Qs({r:Number(e[1])/(e[2]?100/255:1),g:Number(e[3])/(e[4]?100/255:1),b:Number(e[5])/(e[6]?100/255:1),a:e[7]===void 0?1:Number(e[7])/(e[8]?100:1)}):{h:0,s:0,v:0,a:1}},Qs=({r:t,g:e,b:o,a:i})=>{const r=Math.max(t,e,o),n=r-Math.min(t,e,o),s=n?r===t?(e-o)/n:r===e?2+(o-t)/n:4+(t-e)/n:0;return{h:F(60*(s<0?s+6:s)),s:F(r?n/r*100:0),v:F(r/255*100),a:i}},Zs=(t,e)=>{if(t===e)return!0;for(const o in t)if(t[o]!==e[o])return!1;return!0},ea=(t,e)=>t.replace(/\s/g,"")===e.replace(/\s/g,""),Di={},$r=t=>{let e=Di[t];return e||(e=document.createElement("template"),e.innerHTML=t,Di[t]=e),e},No=(t,e,o)=>{t.dispatchEvent(new CustomEvent(e,{bubbles:!0,detail:o}))};let Le=!1;const bo=t=>"touches"in t,ta=t=>Le&&!bo(t)?!1:(Le||(Le=bo(t)),!0),ji=(t,e)=>{const o=bo(e)?e.touches[0]:e,i=t.el.getBoundingClientRect();No(t.el,"move",t.getMove({x:je((o.pageX-(i.left+window.pageXOffset))/i.width),y:je((o.pageY-(i.top+window.pageYOffset))/i.height)}))},oa=(t,e)=>{const o=e.keyCode;o>40||t.xy&&o<37||o<33||(e.preventDefault(),No(t.el,"move",t.getMove({x:o===39?.01:o===37?-.01:o===34?.05:o===33?-.05:o===35?1:o===36?-1:0,y:o===40?.01:o===38?-.01:0},!0)))};class Oo{constructor(e,o,i,r){const n=$r(`<div role="slider" tabindex="0" part="${o}" ${i}><div part="${o}-pointer"></div></div>`);e.appendChild(n.content.cloneNode(!0));const s=e.querySelector(`[part=${o}]`);s.addEventListener("mousedown",this),s.addEventListener("touchstart",this),s.addEventListener("keydown",this),this.el=s,this.xy=r,this.nodes=[s.firstChild,s]}set dragging(e){const o=e?document.addEventListener:document.removeEventListener;o(Le?"touchmove":"mousemove",this),o(Le?"touchend":"mouseup",this)}handleEvent(e){switch(e.type){case"mousedown":case"touchstart":if(e.preventDefault(),!ta(e)||!Le&&e.button!=0)return;this.el.focus(),ji(this,e),this.dragging=!0;break;case"mousemove":case"touchmove":e.preventDefault(),ji(this,e);break;case"mouseup":case"touchend":this.dragging=!1;break;case"keydown":oa(this,e);break}}style(e){e.forEach((o,i)=>{for(const r in o)this.nodes[i].style.setProperty(r,o[r])})}}class ia extends Oo{constructor(e){super(e,"hue",'aria-label="Hue" aria-valuemin="0" aria-valuemax="360"',!1)}update({h:e}){this.h=e,this.style([{left:`${e/360*100}%`,color:fo({h:e,s:100,v:100,a:1})}]),this.el.setAttribute("aria-valuenow",`${F(e)}`)}getMove(e,o){return{h:o?je(this.h+e.x*360,0,360):360*e.x}}}class ra extends Oo{constructor(e){super(e,"saturation",'aria-label="Color"',!0)}update(e){this.hsva=e,this.style([{top:`${100-e.v}%`,left:`${e.s}%`,color:fo(e)},{"background-color":fo({h:e.h,s:100,v:100,a:1})}]),this.el.setAttribute("aria-valuetext",`Saturation ${F(e.s)}%, Brightness ${F(e.v)}%`)}getMove(e,o){return{s:o?je(this.hsva.s+e.x*100,0,100):e.x*100,v:o?je(this.hsva.v-e.y*100,0,100):Math.round(100-e.y*100)}}}const na=':host{display:flex;flex-direction:column;position:relative;width:200px;height:200px;user-select:none;-webkit-user-select:none;cursor:default}:host([hidden]){display:none!important}[role=slider]{position:relative;touch-action:none;user-select:none;-webkit-user-select:none;outline:0}[role=slider]:last-child{border-radius:0 0 8px 8px}[part$=pointer]{position:absolute;z-index:1;box-sizing:border-box;width:28px;height:28px;display:flex;place-content:center center;transform:translate(-50%,-50%);background-color:#fff;border:2px solid #fff;border-radius:50%;box-shadow:0 2px 4px rgba(0,0,0,.2)}[part$=pointer]::after{content:"";width:100%;height:100%;border-radius:inherit;background-color:currentColor}[role=slider]:focus [part$=pointer]{transform:translate(-50%,-50%) scale(1.1)}',sa="[part=hue]{flex:0 0 24px;background:linear-gradient(to right,red 0,#ff0 17%,#0f0 33%,#0ff 50%,#00f 67%,#f0f 83%,red 100%)}[part=hue-pointer]{top:50%;z-index:2}",aa="[part=saturation]{flex-grow:1;border-color:transparent;border-bottom:12px solid #000;border-radius:8px 8px 0 0;background-image:linear-gradient(to top,#000,transparent),linear-gradient(to right,#fff,rgba(255,255,255,0));box-shadow:inset 0 0 0 1px rgba(0,0,0,.05)}[part=saturation-pointer]{z-index:3}",vt=Symbol("same"),so=Symbol("color"),Ui=Symbol("hsva"),ao=Symbol("update"),Fi=Symbol("parts"),Lt=Symbol("css"),zt=Symbol("sliders");let la=class extends HTMLElement{static get observedAttributes(){return["color"]}get[Lt](){return[na,sa,aa]}get[zt](){return[ra,ia]}get color(){return this[so]}set color(t){if(!this[vt](t)){const e=this.colorModel.toHsva(t);this[ao](e),this[so]=t}}constructor(){super();const t=$r(`<style>${this[Lt].join("")}</style>`),e=this.attachShadow({mode:"open"});e.appendChild(t.content.cloneNode(!0)),e.addEventListener("move",this),this[Fi]=this[zt].map(o=>new o(e))}connectedCallback(){if(this.hasOwnProperty("color")){const t=this.color;delete this.color,this.color=t}else this.color||(this.color=this.colorModel.defaultColor)}attributeChangedCallback(t,e,o){const i=this.colorModel.fromAttr(o);this[vt](i)||(this.color=i)}handleEvent(t){const e=this[Ui],o={...e,...t.detail};this[ao](o);let i;!Zs(o,e)&&!this[vt](i=this.colorModel.fromHsva(o))&&(this[so]=i,No(this,"color-changed",{value:i}))}[vt](t){return this.color&&this.colorModel.equal(t,this.color)}[ao](t){this[Ui]=t,this[Fi].forEach(e=>e.update(t))}};class ca extends Oo{constructor(e){super(e,"alpha",'aria-label="Alpha" aria-valuemin="0" aria-valuemax="1"',!1)}update(e){this.hsva=e;const o=no({...e,a:0}),i=no({...e,a:1}),r=e.a*100;this.style([{left:`${r}%`,color:no(e)},{"--gradient":`linear-gradient(90deg, ${o}, ${i}`}]);const n=F(r);this.el.setAttribute("aria-valuenow",`${n}`),this.el.setAttribute("aria-valuetext",`${n}%`)}getMove(e,o){return{a:o?je(this.hsva.a+e.x):e.x}}}const da=`[part=alpha]{flex:0 0 24px}[part=alpha]::after{display:block;content:"";position:absolute;top:0;left:0;right:0;bottom:0;border-radius:inherit;background-image:var(--gradient);box-shadow:inset 0 0 0 1px rgba(0,0,0,.05)}[part^=alpha]{background-color:#fff;background-image:url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill-opacity=".05"><rect x="8" width="8" height="8"/><rect y="8" width="8" height="8"/></svg>')}[part=alpha-pointer]{top:50%}`;class ua extends la{get[Lt](){return[...super[Lt],da]}get[zt](){return[...super[zt],ca]}}const pa={defaultColor:"rgba(0, 0, 0, 1)",toHsva:Xs,fromHsva:Ys,equal:ea,fromAttr:t=>t};class ha extends ua{get colorModel(){return pa}}/**
* @license
* Copyright (c) 2017 - 2023 Vaadin Ltd.
* This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
*/function ma(t){const e=[];for(;t;){if(t.nodeType===Node.DOCUMENT_NODE){e.push(t);break}if(t.nodeType===Node.DOCUMENT_FRAGMENT_NODE){e.push(t),t=t.host;continue}if(t.assignedSlot){t=t.assignedSlot;continue}t=t.parentNode}return e}const lo={start:"top",end:"bottom"},co={start:"left",end:"right"},Bi=new ResizeObserver(t=>{setTimeout(()=>{t.forEach(e=>{e.target.__overlay&&e.target.__overlay._updatePosition()})})}),va=t=>class extends t{static get properties(){return{positionTarget:{type:Object,value:null},horizontalAlign:{type:String,value:"start"},verticalAlign:{type:String,value:"top"},noHorizontalOverlap:{type:Boolean,value:!1},noVerticalOverlap:{type:Boolean,value:!1},requiredVerticalSpace:{type:Number,value:0}}}static get observers(){return["__positionSettingsChanged(horizontalAlign, verticalAlign, noHorizontalOverlap, noVerticalOverlap, requiredVerticalSpace)","__overlayOpenedChanged(opened, positionTarget)"]}constructor(){super(),this.__onScroll=this.__onScroll.bind(this),this._updatePosition=this._updatePosition.bind(this)}connectedCallback(){super.connectedCallback(),this.opened&&this.__addUpdatePositionEventListeners()}disconnectedCallback(){super.disconnectedCallback(),this.__removeUpdatePositionEventListeners()}__addUpdatePositionEventListeners(){window.addEventListener("resize",this._updatePosition),this.__positionTargetAncestorRootNodes=ma(this.positionTarget),this.__positionTargetAncestorRootNodes.forEach(e=>{e.addEventListener("scroll",this.__onScroll,!0)})}__removeUpdatePositionEventListeners(){window.removeEventListener("resize",this._updatePosition),this.__positionTargetAncestorRootNodes&&(this.__positionTargetAncestorRootNodes.forEach(e=>{e.removeEventListener("scroll",this.__onScroll,!0)}),this.__positionTargetAncestorRootNodes=null)}__overlayOpenedChanged(e,o){if(this.__removeUpdatePositionEventListeners(),o&&(o.__overlay=null,Bi.unobserve(o),e&&(this.__addUpdatePositionEventListeners(),o.__overlay=this,Bi.observe(o))),e){const i=getComputedStyle(this);this.__margins||(this.__margins={},["top","bottom","left","right"].forEach(r=>{this.__margins[r]=parseInt(i[r],10)})),this.setAttribute("dir",i.direction),this._updatePosition(),requestAnimationFrame(()=>this._updatePosition())}}__positionSettingsChanged(){this._updatePosition()}__onScroll(e){this.contains(e.target)||this._updatePosition()}_updatePosition(){if(!this.positionTarget||!this.opened)return;const e=this.positionTarget.getBoundingClientRect(),o=this.__shouldAlignStartVertically(e);this.style.justifyContent=o?"flex-start":"flex-end";const i=this.__isRTL,r=this.__shouldAlignStartHorizontally(e,i),n=!i&&r||i&&!r;this.style.alignItems=n?"flex-start":"flex-end";const s=this.getBoundingClientRect(),l=this.__calculatePositionInOneDimension(e,s,this.noVerticalOverlap,lo,this,o),a=this.__calculatePositionInOneDimension(e,s,this.noHorizontalOverlap,co,this,r);Object.assign(this.style,l,a),this.toggleAttribute("bottom-aligned",!o),this.toggleAttribute("top-aligned",o),this.toggleAttribute("end-aligned",!n),this.toggleAttribute("start-aligned",n)}__shouldAlignStartHorizontally(e,o){const i=Math.max(this.__oldContentWidth||0,this.$.overlay.offsetWidth);this.__oldContentWidth=this.$.overlay.offsetWidth;const r=Math.min(window.innerWidth,document.documentElement.clientWidth),n=!o&&this.horizontalAlign==="start"||o&&this.horizontalAlign==="end";return this.__shouldAlignStart(e,i,r,this.__margins,n,this.noHorizontalOverlap,co)}__shouldAlignStartVertically(e){const o=this.requiredVerticalSpace||Math.max(this.__oldContentHeight||0,this.$.overlay.offsetHeight);this.__oldContentHeight=this.$.overlay.offsetHeight;const i=Math.min(window.innerHeight,document.documentElement.clientHeight),r=this.verticalAlign==="top";return this.__shouldAlignStart(e,o,i,this.__margins,r,this.noVerticalOverlap,lo)}__shouldAlignStart(e,o,i,r,n,s,l){const a=i-e[s?l.end:l.start]-r[l.end],c=e[s?l.start:l.end]-r[l.start],d=n?a:c,h=d>(n?c:a)||d>o;return n===h}__adjustBottomProperty(e,o,i){let r;if(e===o.end){if(o.end===lo.end){const n=Math.min(window.innerHeight,document.documentElement.clientHeight);if(i>n&&this.__oldViewportHeight){const s=this.__oldViewportHeight-n;r=i-s}this.__oldViewportHeight=n}if(o.end===co.end){const n=Math.min(window.innerWidth,document.documentElement.clientWidth);if(i>n&&this.__oldViewportWidth){const s=this.__oldViewportWidth-n;r=i-s}this.__oldViewportWidth=n}}return r}__calculatePositionInOneDimension(e,o,i,r,n,s){const l=s?r.start:r.end,a=s?r.end:r.start,c=parseFloat(n.style[l]||getComputedStyle(n)[l]),d=this.__adjustBottomProperty(l,r,c),h=o[s?r.start:r.end]-e[i===s?r.end:r.start],u=d?`${d}px`:`${c+h*(s?-1:1)}px`;return{[l]:u,[a]:""}}};class ga extends CustomEvent{constructor(e){super("color-picker-change",{detail:{value:e}})}}const Ar=x`
  :host {
    --preview-size: 24px;
...
`;let tt=class extends P{constructor(){super(...arguments),this.commitValue=!1}static get styles(){return[Ar,x`
        #toggle {
          display: block;
        }
    ...
    ></button>`}open(){this.commitValue=!1,this.overlay.opened=!0,this.overlay.style.zIndex="1000000";const t=this.overlay.shadowRoot.querySelector('[part="overlay"]');t.style.background="#333"}renderOverlayContent(t){const e=getComputedStyle(this.toggle,"::after").getPropertyValue("background-color");we(b` <div>
        ...
        ></vaadin-dev-tools-color-picker-overlay-content>
      </div>`,t)}handleColorChange(t){this.commitValue=!0,this.dispatchEvent(new ga(t.detail.value)),t.detail.close&&(this.overlay.opened=!1,this.handleOverlayClose())}handleOverlayEscape(){this.commitValue=!1}handleOverlayClose(){const t=this.commitValue?"color-picker-commit":"color-picker-cancel";this.dispatchEvent(new CustomEvent(t))}};v([w({})],tt.prototype,"value",void 0);v([w({})],tt.prototype,"presets",void 0);v([it("#toggle")],tt.prototype,"toggle",void 0);tt=v([V("vaadin-dev-tools-color-picker")],tt);let Mt=class extends P{static get styles(){return[Ar,x`
        :host {
          display: block;
          padding: 12px;
        }
    ...
    `];Dt=v([V("vaadin-dev-tools-shim")],Dt);const ba={resolve:t=>ue(e=>e.classList.contains("cc-banner"),t)?document.querySelector("vaadin-cookie-consent"):void 0},ya={resolve:t=>{const e=ue(o=>o.localName==="vaadin-login-overlay-wrapper",t);return e?e.__dataHost:void 0}},xa={resolve:t=>t.localName==="vaadin-dialog-overlay"?t.__dataHost:void 0},wa={resolve:t=>{const e=ue(o=>o.localName==="vaadin-confirm-dialog-overlay",t);return e?e.__dataHost:void 0}},_a={resolve:t=>{const e=ue(o=>o.localName==="vaadin-notification-card",t);return e?e.__dataHost:void 0}},Ea={resolve:t=>t.localName!=="vaadin-menu-bar-item"?void 0:ue(e=>e.localName==="vaadin-menu-bar",t)},Wi=[ba,ya,xa,wa,_a,Ea],Sa={resolve:t=>ue(e=>e.classList.contains("cc-banner"),t)},ka={resolve:t=>{var e;const o=ue(i=>{var r;return((r=i.shadowRoot)==null?void 0:r.querySelector("[part=overlay]"))!=null},t);return(e=o==null?void 0:o.shadowRoot)==null?void 0:e.querySelector("[part=overlay]")}},Ca={resolve:t=>{var e;const o=ue(i=>i.localName==="vaadin-login-overlay-wrapper",t);return(e=o==null?void 0:o.shadowRoot)==null?void 0:e.querySelector("[part=card]")}},qi=[Ca,Sa,ka],ue=function(t,e){return t(e)?e:e.parentNode&&e.parentNode instanceof HTMLElement?ue(t,e.parentNode):void 0};class Ta{resolveElement(e){for(const o in Wi){let i=e;if((i=Wi[o].resolve(e))!==void 0)return i}return e}}class $a{resolveElement(e){for(const o in qi){let i=e;if((i=qi[o].resolve(e))!==void 0)return i}return e}}const Aa=new Ta,Ra=new $a;let ve=class extends P{constructor(){super(),this.active=!1,this.components=[],this.selected=0,this.mouseMoveEvent=this.mouseMoveEvent.bind(this)}connectedCallback(){super.connectedCallback();const t=new CSSStyleSheet;t.replaceSync(`
...
`)+o.textContent.trim()).join("").replace(/^\n/,"");ja(e),this._devTools.showNotification(j.INFORMATION,"Environment information copied to clipboard",void 0,void 0,"versionInfoCopied")}};v([w({type:Object})],jt.prototype,"_devTools",void 0);v([I()],jt.prototype,"serverInfo",void 0);jt=v([V("vaadin-dev-tools-info")],jt);let yo=class extends P{createRenderRoot(){return this}activate(){this._devTools.unreadErrors=!1,this.updateComplete.then(()=>{const t=this.renderRoot.querySelector(".message-tray .message:last-child");t&&t.scrollIntoView()})}render(){return b`<div class="message-tray">
    ...
    `}render(){return b` <div
      ...
      </div>`}updated(t){var e;super.updated(t);const o=this.renderRoot.querySelector("#tabContainer"),i=[];if(this.tabs.forEach(n=>{n.element||(typeof n.render=="function"?n.element=document.createElement("div"):(n.element=document.createElement(n.render),n.element._devTools=this),i.push(n.element))}),(o==null?void 0:o.childElementCount)!==this.tabs.length){for(let n=0;n<this.tabs.length;n++){const s=this.tabs[n];o.childElementCount>n&&o.children[n]===s.element||o.insertBefore(s.element,o.children[n])}for(;(o==null?void 0:o.childElementCount)>this.tabs.length;)(e=o.lastElementChild)==null||e.remove()}for(const n of this.tabs){typeof n.render=="function"?we(n.render(),n.element):n.element.requestUpdate&&n.element.requestUpdate();const s=n.id===this.activeTab;n.element.hidden=!s}for(const n of i)for(var r=0;r<this.unhandledMessages.length;r++)this.tabHandleMessage(n,this.unhandledMessages[r])&&(this.unhandledMessages.splice(r,1),r--)}renderCode(){return b`<div class="info-tray">
      <div>
    ...
    ></vaadin-dev-tools-theme-editor>`}toggleFeatureFlag(t,e){const o=t.target.checked;this.frontendConnection?(this.frontendConnection.send("setFeature",{featureId:e.id,enabled:o}),this.showNotification(j.INFORMATION,`“${e.title}” ${o?"enabled":"disabled"}`,e.requiresServerRestart?"This feature requires a server restart":void 0,void 0,`feature${e.id}${o?"Enabled":"Disabled"}`)):this.log(j.ERROR,`Unable to toggle feature ${e.title}: No server connection available`)}};C.MAX_LOG_ROWS=1e3;C.DISMISSED_NOTIFICATIONS_IN_LOCAL_STORAGE="vaadin.live-reload.dismissedNotifications";C.ACTIVE_KEY_IN_SESSION_STORAGE="vaadin.live-reload.active";C.TRIGGERED_KEY_IN_SESSION_STORAGE="vaadin.live-reload.triggered";C.TRIGGERED_COUNT_KEY_IN_SESSION_STORAGE="vaadin.live-reload.triggeredCount";C.AUTO_DEMOTE_NOTIFICATION_DELAY=5e3;C.HOTSWAP_AGENT="HOTSWAP_AGENT";C.JREBEL="JREBEL";C.SPRING_BOOT_DEVTOOLS="SPRING_BOOT_DEVTOOLS";C.BACKEND_DISPLAY_NAME={HOTSWAP_AGENT:"HotswapAgent",JREBEL:"JRebel",SPRING_BOOT_DEVTOOLS:"Spring Boot Devtools"};v([w({type:Boolean,attribute:!1})],C.prototype,"expanded",void 0);v([w({type:Array,attribute:!1})],C.prototype,"messages",void 0);v([w({type:String,attribute:!1})],C.prototype,"splashMessage",void 0);v([w({type:Array,attribute:!1})],C.prototype,"notifications",void 0);v([w({type:String,attribute:!1})],C.prototype,"frontendStatus",void 0);v([w({type:String,attribute:!1})],C.prototype,"javaStatus",void 0);v([I()],C.prototype,"tabs",void 0);v([I()],C.prototype,"activeTab",void 0);v([I()],C.prototype,"features",void 0);v([I()],C.prototype,"unreadErrors",void 0);v([it(".window")],C.prototype,"root",void 0);v([it("vaadin-dev-tools-component-picker")],C.prototype,"componentPicker",void 0);v([I()],C.prototype,"componentPickActive",void 0);v([I()],C.prototype,"themeEditorState",void 0);C=T=v([V("vaadin-dev-tools")],C);const{toString:Fa}=Object.prototype;function Ba(t){return Fa.call(t)==="[object RegExp]"}function Ha(t,{preserve:e=!0,whitespace:o=!0,all:i}={}){if(i)throw new Error("The `all` option is no longer supported. Use the `preserve` option instead.");let r=e,n;typeof e=="function"?(r=!1,n=e):Ba(e)&&(r=!1,n=d=>e.test(d));let s=!1,l="",a="",c="";for(let d=0;d<t.length;d++){if(l=t[d],t[d-1]!=="\\"&&(l==='"'||l==="'")&&(s===l?s=!1:s||(s=l)),!s&&l==="/"&&t[d+1]==="*"){const h=t[d+2]==="!";let u=d+2;for(;u<t.length;u++){if(t[u]==="*"&&t[u+1]==="/"){r&&h||n&&n(a)?c+=`/*${a}*/`:o||(t[u+2]===`
`?u++:t[u+2]+t[u+3]===`\r
`&&(u+=2)),a="";break}a+=t[u]}d=u+1;continue}c+=l}return c}const Wa=CSSStyleSheet.toString().includes("document.createElement"),qa=(t,e)=>{const o=/(?:@media\s(.+?))?(?:\s{)?\@import\s*(?:url\(\s*['"]?(.+?)['"]?\s*\)|(["'])((?:\\.|[^\\])*?)\3)([^;]*);(?:})?/g;/\/\*(.|[\r\n])*?\*\//gm.exec(t)!=null&&(t=Ha(t));for(var i,r=t;(i=o.exec(t))!==null;){r=r.replace(i[0],"");const n=document.createElement("link");n.rel="stylesheet",n.href=i[2]||i[4];const s=i[1]||i[5];s&&(n.media=s),e===document?document.head.appendChild(n):e.appendChild(n)}return r},Ga=(t,e,o)=>(o?e.adoptedStyleSheets=[t,...e.adoptedStyleSheets]:e.adoptedStyleSheets=[...e.adoptedStyleSheets,t],()=>{e.adoptedStyleSheets=e.adoptedStyleSheets.filter(i=>i!==t)}),Ka=(t,e,o)=>{const i=new CSSStyleSheet;return i.replaceSync(t),Wa?Ga(i,e,o):(o?e.adoptedStyleSheets.splice(0,0,i):e.adoptedStyleSheets.push(i),()=>{e.adoptedStyleSheets.splice(e.adoptedStyleSheets.indexOf(i),1)})},Ja=(t,e)=>{const o=document.createElement("style");o.type="text/css",o.textContent=t;let i;if(e){const n=Array.from(document.head.childNodes).filter(s=>s.nodeType===Node.COMMENT_NODE).find(s=>s.data.trim()===e);n&&(i=n)}return document.head.insertBefore(o,i),()=>{o.remove()}},He=(t,e,o,i)=>{if(o===document){const n=Ya(t);if(window.Vaadin.theme.injectedGlobalCss.indexOf(n)!==-1)return;window.Vaadin.theme.injectedGlobalCss.push(n)}const r=qa(t,o);return o===document?Ja(r,e):Ka(r,o,i)};window.Vaadin=window.Vaadin||{};window.Vaadin.theme=window.Vaadin.theme||{};window.Vaadin.theme.injectedGlobalCss=[];function Ji(t){let e,o,i=2166136261;for(e=0,o=t.length;e<o;e++)i^=t.charCodeAt(e),i+=(i<<1)+(i<<4)+(i<<7)+(i<<8)+(i<<24);return("0000000"+(i>>>0).toString(16)).substr(-8)}function Ya(t){let e=Ji(t);return e+Ji(e+t)}/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Xa=t=>class extends t{static get properties(){return{_theme:{type:String,readOnly:!0}}}static get observedAttributes(){return[...super.observedAttributes,"theme"]}attributeChangedCallback(o,i,r){super.attributeChangedCallback(o,i,r),o==="theme"&&this._set_theme(r)}};/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const Pr=[];function Ir(t){return t&&Object.prototype.hasOwnProperty.call(t,"__themes")}function Qa(t){return Ir(customElements.get(t))}function Za(t=[]){return[t].flat(1/0).filter(e=>e instanceof So?!0:(console.warn("An item in styles is not of type CSSResult. Use `unsafeCSS` or `css`."),!1))}function rt(t,e,o={}){t&&Qa(t)&&console.warn(`The custom element definition for "${t}"
      was finalized before a style module was registered.
      Make sure to add component specific style modules before
      importing the corresponding custom element.`),e=Za(e),window.Vaadin&&window.Vaadin.styleModules?window.Vaadin.styleModules.registerStyles(t,e,o):Pr.push({themeFor:t,styles:e,include:o.include,moduleId:o.moduleId})}function xo(){return window.Vaadin&&window.Vaadin.styleModules?window.Vaadin.styleModules.getAllThemes():Pr}function el(t,e){return(t||"").split(" ").some(o=>new RegExp(`^${o.split("*").join(".*")}$`,"u").test(e))}function tl(t=""){let e=0;return t.startsWith("lumo-")||t.startsWith("material-")?e=1:t.startsWith("vaadin-")&&(e=2),e}function Nr(t){const e=[];return t.include&&[].concat(t.include).forEach(o=>{const i=xo().find(r=>r.moduleId===o);i?e.push(...Nr(i),...i.styles):console.warn(`Included moduleId ${o} not found in style registry`)},t.styles),e}function ol(t,e){const o=document.createElement("style");o.innerHTML=t.map(i=>i.cssText).join(`
`),e.content.appendChild(o)}function il(t){const e=`${t}-default-theme`,o=xo().filter(i=>i.moduleId!==e&&el(i.themeFor,t)).map(i=>({...i,styles:[...Nr(i),...i.styles],includePriority:tl(i.moduleId)})).sort((i,r)=>r.includePriority-i.includePriority);return o.length>0?o:xo().filter(i=>i.moduleId===e)}const Al=t=>class extends Xa(t){static finalize(){if(super.finalize(),this.elementStyles)return;const o=this.prototype._template;!o||Ir(this)||ol(this.getStylesForThis(),o)}static finalizeStyles(o){const i=this.getStylesForThis();return o?[...super.finalizeStyles(o),...i]:i}static getStylesForThis(){const o=Object.getPrototypeOf(this.prototype),i=(o?o.constructor.__themes:[])||[];this.__themes=[...i,...il(this.is)];const r=this.__themes.flatMap(n=>n.styles);return r.filter((n,s)=>s===r.lastIndexOf(n))}};/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const rl=(t,...e)=>{const o=document.createElement("style");o.id=t,o.textContent=e.map(i=>i.toString()).join(`
`).replace(":host","html"),document.head.insertAdjacentElement("afterbegin",o)},nl=':host(:not([theme~="tertiary"])){background-image:linear-gradient(var(--lumo-tint-5pct),var(--lumo-shade-5pct));box-shadow:inset 0 0 0 1px var(--lumo-contrast-20pct)}:host(:not([theme~="tertiary"]):not([theme~="primary"]):not([theme~="error"]):not([theme~="success"])){color:var(--lumo-body-text-color)}:host([focus-ring]:not([theme~="tertiary"])){box-shadow:0 0 0 2px var(--lumo-primary-color-50pct),inset 0 0 0 1px var(--lumo-primary-color)}:host([focus-ring][theme~="primary"]){box-shadow:0 0 0 2px var(--lumo-primary-color-50pct),inset 0 0 0 1px var(--lumo-primary-contrast-color)}:host([theme~="primary"]){text-shadow:0 -1px 0 var(--lumo-shade-20pct)}';document["_vaadintheme_my-portfolio_componentCss"]||(rt("vaadin-button",ko(nl.toString())),document["_vaadintheme_my-portfolio_componentCss"]=!0);/**
 * @license
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */function sl(t){const e=customElements.get(t.is);if(!e)Object.defineProperty(t,"version",{get(){return"24.3.6"}}),customElements.define(t.is,t);else{const o=e.version;o&&t.version&&o===t.version?console.warn(`The component ${t.is} has been loaded twice`):console.error(`Tried to define ${t.is} version ${t.version} when version ${e.version} is already in use. Something will probably break.`)}}/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class al extends HTMLElement{static get is(){return"vaadin-lumo-styles"}}sl(al);const ge=(t,...e)=>{rl(`lumo-${t}`,e)};/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const ll=x`
...
`;rt("",zo,{moduleId:"lumo-typography"});ge("typography-props",ll);/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */const cl=x`
  ${ko(zo.cssText.replace(/,\s*:host/su,""))}
`;ge("typography",cl);/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
${wl}
${_l}
`;rt("",Do,{moduleId:"lumo-utility"});/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */ge("utility",Do);const El=t=>{const e=[];t!==document&&(e.push(He(zo.cssText,"",t,!0)),e.push(He(Mo.cssText,"",t,!0)),e.push(He(Or.cssText,"",t,!0)),e.push(He(Vo.cssText,"",t,!0)),e.push(He(Do.cssText,"",t,!0)))},Sl=El;Sl(document);export{Ns as A,Rs as C,cs as D,ee as I,P as L,oe as N,le as O,as as P,Na as R,Ps as S,Al as T,vo as _,ge as a,Xa as b,x as c,sl as d,we as e,ls as f,Se as g,b as h,Mo as i,zo as j,R as k,Oa as l,Is as m,$ as n,La as o,Cl as p,Tl as q,rt as r,Ie as s,Pr as t,ko as u};
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["./vaadin-big-decimal-field-e51def24-e_0JBTFQ.js","./vaadin-text-field-0b3db014-U4agpn8T.js","./vaadin-button-2511ad84-66VvHaa1.js","./vaadin-checkbox-group-a7c65bf2-DfkyZkx_.js","./vaadin-checkbox-4e68df64-DkXxjuI4.js","./vaadin-combo-box-96451ddd-C04HfxSd.js","./vaadin-confirm-dialog-4d718829-5TZkEokF.js","./vaadin-custom-field-42c85b9e-CO7dheV3.js","./vaadin-date-picker-f2001167-PjjOZGBy.js","./vaadin-date-time-picker-c8c047a7-BG68xezH.js","./vaadin-email-field-d7a35f04-CQQ2Zylu.js","./vaadin-grid-pro-ff415555-Dp1b65jW.js","./vaadin-grid-0a4791c2-7x0JA_PF.js","./vaadin-integer-field-85078932-Bo9DO0Pa.js","./vaadin-login-form-638996c6-Bi7ZKdN6.js","./vaadin-login-overlay-f8a5db8a-C39yHOr6.js","./vaadin-message-input-996ac37c-_OV1OyN-.js","./vaadin-multi-select-combo-box-a3373557-Bps9uIFG.js","./vaadin-number-field-cb3ee8b2-DK5wdbVG.js","./vaadin-password-field-d289cb18-CTuD773y.js","./vaadin-radio-group-88b5afd8-DfGNY-gA.js","./vaadin-select-df6e9947-CKC4v5_c.js","./vaadin-text-area-83627ebc-D_yBoy15.js","./vaadin-time-picker-715ec415-C2T-qfDG.js","./vaadin-upload-d3c162ed-1ocxF_zJ.js"]
  }
